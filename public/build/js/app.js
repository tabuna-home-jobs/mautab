if (!function (t, e) {
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, c, u, p = this, d = {}, f = t.style, h = t.nodeType && Ct(t), g = vt.get(t, "fxshow");
            ...
            })), 1 === t.nodeType && ("height"in e || "width"in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = Z.css(t, "display"), u = "none" === c ? vt.get(t, "olddisplay") || w(t.nodeName) : c, "inline" === u && "none" === Z.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function () {
            ...
            if (Z.isEmptyObject(d))"inline" === ("none" === c ? w(t.nodeName) : c) && (f.display = c); else {
        ...
        var ot = function (t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : F) !== O && A(e), e = e || O, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a)return n;
                if (!i && q) {
                    ...
                    if (x.qsa && (!L || !L.test(t))) {
                        if (f = p = _, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = k(t), (p = e.getAttribute("id")) ? f = p.replace(wt, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;)c[l] = f + d(c[l]);
            ...
            function f(t, e, n) {
                ...
                return e.first ? function (e, n, r) {
                    ...
                    if (s) {
                        ...
                        if (l = e[_] || (e[_] = {}), (a = l[i]) && a[0] === W && a[1] === r)return c[2] = a[2];
                ...
                return o && !o[_] && (o = v(o)), r && !r[_] && (r = v(r, s)), i(function (i, s, a, l) {
                    ...
                    if (i) {
                        if (r || t) {
                            ...
                            for (u = b.length; u--;)(p = b[u]) && (c = r ? tt(i, p) : d[u]) > -1 && (i[c] = !(s[c] = p))
                        }
            ...
            function y(t) {
                for (var e, n, i, o = t.length, r = T.relative[t[0].type], s = r || T.relative[" "], a = r ? 1 : 0, l = f(function (t) {
                    ...
                    if (n = T.filter[t[a].type].apply(null, t[a].matches), n[_]) {
                        ...
                        return v(a > 1 && h(u), a > 1 && d(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(lt, "$1"), n, i > a && y(t.slice(a, i)), o > i && y(t = t.slice(i)), o > i && d(t))
                    }
                    u.push(n)
                }
                return h(u)
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                    var u, p, d, f = 0, h = "0", g = i && [], v = [], y = S, b = i || r && T.find.TAG("*", c), w = W += null == y ? 1 : Math.random() || .1, x = b.length;
                    for (c && (S = s !== O && s); h !== x && null != (u = b[h]); h++) {
                        if (r && u) {
            ...
            var w, x, T, C, j, k, E, $, S, N, D, A, O, I, q, L, R, P, H, _ = "sizzle" + 1 * new Date, F = t.document, W = 0, M = 0, B = n(), U = n(), z = n(), V = function (t, e) {
                return t === e && (D = !0), 0
            }, Q = 1 << 31, X = {}.hasOwnProperty, Y = [], G = Y.pop, J = Y.push, K = Y.push, Z = Y.slice, tt = function (t, e) {
                for (var n = 0, i = t.length; i > n; n++)if (t[n] === e)return n;
                return -1
            }, et = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ot = it.replace("w", "w#"), rt = "\\[" + nt + "*(" + it + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ot + "))|)" + nt + "*\\]", st = ":(" + it + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + rt + ")*)|.*)\\)|)", at = new RegExp(nt + "+", "g"), lt = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$", "g"), ct = new RegExp("^" + nt + "*," + nt + "*"), ut = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), pt = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]", "g"), dt = new RegExp(st), ft = new RegExp("^" + ot + "$"), ht = {
                ID: new RegExp("^#(" + it + ")"),
                CLASS: new RegExp("^\\.(" + it + ")"),
            ...
            x = e.support = {}, j = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), q = !j(i), x.attributes = o(function (t) {
                    return t.className = "i", !t.getAttribute("className")
                }), x.getElementsByTagName = o(function (t) {
                    return t.appendChild(i.createComment("")), !t.getElementsByTagName("*").length
                }), x.getElementsByClassName = vt.test(i.getElementsByClassName), x.getById = o(function (t) {
                    return I.appendChild(t).id = _, !i.getElementsByName || !i.getElementsByName(_).length
                    ...
                    I.appendChild(t).innerHTML = "<a id='" + _ + "'></a><select id='" + _ + "-\f]' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && L.push("[*^$]=" + nt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || L.push("\\[" + nt + "*(?:value|" + et + ")"), t.querySelectorAll("[id~=" + _ + "-]").length || L.push("~="), t.querySelectorAll(":checked").length || L.push(":checked"), t.querySelectorAll("a#" + _ + "+*").length || L.push(".#.+[+~]")
                }), o(function (t) {
                ...
                })), (x.matchesSelector = vt.test(P = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function (t) {
                    x.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), R.push("!=", st)
                }), L = L.length && new RegExp(L.join("|")), R = R.length && new RegExp(R.join("|")), e = vt.test(I.compareDocumentPosition), H = e || vt.test(I.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === F && H(F, t) ? -1 : e === i || e.ownerDocument === F && H(F, e) ? 1 : N ? tt(N, t) - tt(N, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return D = !0, 0;
                ...
                if ((t.ownerDocument || t) !== O && A(t), n = n.replace(pt, "='$1']"), !(!x.matchesSelector || !q || R && R.test(n) || L && L.test(n)))try {
                    var i = P.call(t, n);
                ...
                var n = T.attrHandle[e.toLowerCase()], i = n && X.call(T.attrHandle, e.toLowerCase()) ? n(t, e, !q) : void 0;
                return void 0 !== i ? i : x.attributes || !q ? t.getAttribute(e) : (i = t.getAttributeNode(e)) && i.specified ? i.value : null
            }, e.error = function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[_] || (m[_] = {}), c = u[t] || [], f = c[0] === W && c[1], d = c[0] === W && c[2], p = f && m.childNodes[f]; p = ++f && p && p[g] || (d = f = 0) || h.pop();)if (1 === p.nodeType && ++d && p === e) {
                                        u[t] = [W, f, d];
                                        break
                                    }
                                } else if (y && (c = (e[_] || (e[_] = {}))[t]) && c[0] === W)d = c[1]; else for (; (p = ++f && p && p[g] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[_] || (p[_] = {}))[t] = [W, d]), p !== e)););
            ...
            return p.prototype = T.filters = T.pseudos, T.setFilters = new p, k = e.tokenize = function (t, n) {
                ...
                if (n = n || [], 1 === p.length) {
                    if (r = p[0] = p[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && x.getById && 9 === e.nodeType && q && T.relative[r[1].type]) {
                        if (e = (T.find.ID(s.matches[0].replace(xt, Tt), e) || [])[0], !e)return n;
                        c && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = ht.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)if ((l = T.find[a]) && (i = l(s.matches[0].replace(xt, Tt), bt.test(r[0].type) && u(e.parentNode) || e))) {
                        if (r.splice(o, 1), t = i.length && d(r), !t)return K.apply(n, i), n;
                        break
                    }
                }
                return (c || E(t, p))(i, e, !q, n, bt.test(t) && u(e.parentNode) || e), n
            }, x.sortStable = _.split("").sort(V).join("") === _, x.detectDuplicates = !!D, A(), x.sortDetached = o(function (t) {
        ...
        var lt, ct = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ut = Z.fn.init = function (t, e) {
            var n, i;
            if (!t)return this;
            if ("string" == typeof t) {
        ...
        Z.event = {
            ...
            add: function (t, e, n, i, o) {
                ...
                }), e = (e || "").match(ft) || [""], c = e.length; c--;)a = Nt.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (p = Z.event.special[f] || {}, f = (o ? p.delegateType : p.bindType) || f, p = Z.event.special[f] || {}, u = Z.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
            ...
            remove: function (t, e, n, i, o) {
                ...
                if (m && (l = m.events)) {
                    for (e = (e || "").match(ft) || [""], c = e.length; c--;)if (a = Nt.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
            ...
            trigger: function (e, n, i, o) {
                var r, s, a, l, c, u, p, d = [i || J], f = Y.call(e, "type") ? e.type : e, h = Y.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !St.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), p = Z.event.special[f] || {}, o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                    ...
                    for (r = 0; (s = d[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? l : p.bindType || f, u = (vt.get(s, "events") || {})[e.type] && vt.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
            ...
            dispatch: function (t) {
                t = Z.event.fix(t);
                var e, n, i, o, r, s = [], a = B.call(arguments), l = (vt.get(this, "events") || {})[t.type] || [], c = Z.event.special[t.type] || {};
        ...
        var Dt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, At = /<([\w:]+)/, Ot = /<|&#?\w+;/, It = /<(?:script|style|link)/i, qt = /checked\s*(?:[^=]|=\s*.checked.)/i, Lt = /^$|\/(?:java|ecma)script/i, Rt = /^true\/(.*)/, Pt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Ht = {
        ...
        Ht.optgroup = Ht.option, Ht.tbody = Ht.tfoot = Ht.colgroup = Ht.caption = Ht.thead, Ht.th = Ht.td, Z.extend({
            clone: function (t, e, n) {
                ...
                for (var o, r, s, a, l, c, u = e.createDocumentFragment(), p = [], d = 0, f = t.length; f > d; d++)if (o = t[d], o || 0 === o)if ("object" === Z.type(o))Z.merge(p, o.nodeType ? [o] : o); else if (Ot.test(o)) {
                    for (r = r || u.appendChild(e.createElement("div")), s = (At.exec(o) || ["", ""])[1].toLowerCase(), a = Ht[s] || Ht._default, r.innerHTML = a[1] + o.replace(Dt, "<$1></$2>") + a[2], c = a[0]; c--;)r = r.lastChild;
                    Z.merge(p, r.childNodes), r = u.firstChild, r.textContent = ""
                } else p.push(e.createTextNode(o));
                for (u.textContent = "", d = 0; o = p[d++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(u.appendChild(o), "script"), l && g(r), n))for (c = 0; o = r[c++];)Lt.test(o.type || "") && n.push(o);
                return u
            ...
            text: function (t) {
                ...
                return mt(this, function (t) {
                    ...
                    if ("string" == typeof t && !It.test(t) && !Ht[(At.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Dt, "<$1></$2>");
                        try {
                ...
                if (g || c > 1 && "string" == typeof d && !G.checkClone && qt.test(d))return this.each(function (n) {
                    var i = u.eq(n);
                ...
                if (c && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    ...
                    if (r)for (a = o[o.length - 1].ownerDocument, Z.map(o, h), l = 0; r > l; l++)s = o[l], Lt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Pt, "")))
                }
                return this
            }
        }), Z.each({
        ...
        var _t, Ft = {}, Wt = /^margin/, Mt = new RegExp("^(" + xt + ")(?!px)[a-z%]+$", "i"), Bt = function (e) {
        ...
        var Gt, Jt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + xt + ")([a-z%]*)$", "i"), te = /queueHooks$/, ee = [O], ne = {
            "*": [function (t, e) {
        ...
        Z.fn.extend({
            addClass: function (t) {
                ...
                if (a)for (e = (t || "").match(ft) || []; c > l; l++)if (n = this[l], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(ae, " ") : " ")) {
        ...
        Z.extend({
            ...
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, u, v, y, w, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", x.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = H(p, x, n)), y = _(p, y, x, l), l ? (p.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (Z.lastModified[o] = w), w = x.getResponseHeader("etag"), w && (Z.etag[o] = w)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, u = y.data, v = y.error, l = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (e || T) + "", l ? h.resolveWith(d, [u, T, x]) : h.rejectWith(d, [x, T, v]), x.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [x, p, l ? u : v]), g.fireWith(d, [x, T]), c && (f.trigger("ajaxComplete", [x, p]), --Z.active || Z.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, c, u, p = Z.ajaxSetup({}, e), d = p.context || p, f = p.context && (d.nodeType || d.jquery) ? Z(d) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
                    readyState: 0,
                ...
                c = Z.event && p.global, c && 0 === Z.active++ && Z.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !ge.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (ue.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = de.test(o) ? o.replace(de, "$1_=" + ce++) : o + (ue.test(o) ? "&" : "?") + "_=" + ce++)), p.ifModified && (Z.lastModified[o] && x.setRequestHeader("If-Modified-Since", Z.lastModified[o]), Z.etag[o] && x.setRequestHeader("If-None-Match", Z.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || e.contentType) && x.setRequestHeader("Content-Type", p.contentType), x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + we + "; q=0.01" : "") : p.accepts["*"]);
                ...
                if (i = R(be, p, e, x)) {
                    x.readyState = 1, c && f.trigger("ajaxSend", [x, p]), p.async && p.timeout > 0 && (a = setTimeout(function () {
                        x.abort("timeout")
                    }, p.timeout));
                    try {
                        b = 1, i.send(v, n)
