if (!function (t, e) {
        ...
        function w(t) {
            var e = J, n = Ft[t];
            return n || (n = b(t, e), "none" !== n && n || (Ht = (Ht || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Ht[0].contentDocument, e.write(), e.close(), n = b(t, e), Ht.detach()), Ft[t] = n), n
        }

        function x(t, e, n) {
            var i, o, r, s, a = t.style;
            return n = n || Bt(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || Z.contains(t.ownerDocument, t) || (s = Z.style(t, e)), Mt.test(s) && Wt.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function E(t, e, n) {
            var i = !0, o = "width" === e ? t.offsetWidth : t.offsetHeight, r = Bt(t), s = "border-box" === Z.css(t, "boxSizing", !1, r);
            if (0 >= o || null == o) {
        ...
        function $(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)i = t[s], i.style && (r[s] = vt.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ct(i) && (r[s] = vt.access(i, "olddisplay", w(i.nodeName)))) : (o = Ct(i), "none" === n && o || vt.set(i, "olddisplay", o ? n : Z.css(i, "display"))));
        ...
        function q(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height"in e || "width"in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = Z.css(t, "display"), c = "none" === u ? vt.get(t, "olddisplay") || w(t.nodeName) : u, "inline" === c && "none" === Z.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function () {
            ...
            if (Z.isEmptyObject(d))"inline" === ("none" === u ? w(t.nodeName) : u) && (f.display = u); else {
        ...
        function I(t, e, n) {
            var i, o, r = 0, s = ee.length, a = Z.Deferred().always(function () {
                ...
                if (o)return !1;
                for (var e = Gt || N(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; l > s; s++)u.tweens[s].run(r);
            ...
            for (O(c, u.opts.specialEasing); s > r; r++)if (i = ee[r].call(u, t, c, u.opts))return i;
            return Z.map(c, A, u), Z.isFunction(u.opts.start) && u.opts.start.call(t, u), Z.fx.timer(Z.extend(l, {
                elem: t,
                anim: u,
                queue: u.opts.queue
        ...
        function F(t, e, n, i) {
            ...
            if (Z.isArray(e))Z.each(e, function (e, o) {
                n || je.test(t) ? i(t, o) : F(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
        ...
        var M = [], B = M.slice, U = M.concat, z = M.push, V = M.indexOf, Q = {}, X = Q.toString, Y = Q.hasOwnProperty, G = {}, J = t.document, K = "2.1.4", Z = function (t, e) {
        ...
        var ot = function (t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : F) !== q && A(e), e = e || q, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a)return n;
                if (!i && I) {
                    ...
                    if (x.qsa && (!L || !L.test(t))) {
                        if (f = p = H, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, u) {
                    var c, p, d, f = 0, h = "0", g = i && [], v = [], y = S, b = i || r && T.find.TAG("*", u), w = W += null == y ? 1 : Math.random() || .1, x = b.length;
                    for (u && (S = s !== q && s); h !== x && null != (c = b[h]); h++) {
                        if (r && c) {
            ...
            var w, x, T, C, j, k, E, $, S, N, D, A, q, O, I, L, R, _, P, H = "sizzle" + 1 * new Date, F = t.document, W = 0, M = 0, B = n(), U = n(), z = n(), V = function (t, e) {
                return t === e && (D = !0), 0
            }, Q = 1 << 31, X = {}.hasOwnProperty, Y = [], G = Y.pop, J = Y.push, K = Y.push, Z = Y.slice, tt = function (t, e) {
            ...
            }, gt = /^(?:input|select|textarea|button)$/i, mt = /^h\d$/i, vt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, wt = /'|\\/g, xt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)", "ig"), Tt = function (t, e, n) {
                var i = "0x" + e - 65536;
            ...
            x = e.support = {}, j = e.isXML = function (t) {
                ...
                return i !== q && 9 === i.nodeType && i.documentElement ? (q = i, O = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), I = !j(i), x.attributes = o(function (t) {
                    ...
                    }, R = [], L = [], (x.qsa = vt.test(i.querySelectorAll)) && (o(function (t) {
                ...
                })), (x.matchesSelector = vt.test(_ = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function (t) {
                    x.disconnectedMatch = _.call(t, "div"), _.call(t, "[s!='']:x"), R.push("!=", st)
                }), L = L.length && new RegExp(L.join("|")), R = R.length && new RegExp(R.join("|")), e = vt.test(O.compareDocumentPosition), P = e || vt.test(O.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === F && P(F, t) ? -1 : e === i || e.ownerDocument === F && P(F, e) ? 1 : N ? tt(N, t) - tt(N, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return D = !0, 0;
                ...
                if ((t.ownerDocument || t) !== q && A(t), n = n.replace(pt, "='$1']"), !(!x.matchesSelector || !I || R && R.test(n) || L && L.test(n)))try {
                    var i = _.call(t, n);
                ...
                return (t.ownerDocument || t) !== q && A(t), P(t, e)
            }, e.attr = function (t, e) {
                ...
                var e, n = [], i = 0, o = 0;
                if (D = !x.detectDuplicates, N = !x.sortStable && t.slice(0), t.sort(V), D) {
                ...
                preFilter: {
                    ATTR: function (t) {
                        ...
                        var e, n = !t[6] && t[2];
                        return ht.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && dt.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (c = m[H] || (m[H] = {}), u = c[t] || [], f = u[0] === W && u[1], d = u[0] === W && u[2], p = f && m.childNodes[f]; p = ++f && p && p[g] || (d = f = 0) || h.pop();)if (1 === p.nodeType && ++d && p === e) {
                                        c[t] = [W, f, d];
                                        break
                                    }
                                } else if (y && (u = (e[H] || (e[H] = {}))[t]) && u[0] === W)d = u[1]; else for (; (p = ++f && p && p[g] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[H] || (p[H] = {}))[t] = [W, d]), p !== e)););
                ...
                pseudos: {
                    not: i(function (t) {
                        ...
                        return ft.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(xt, Tt).toLowerCase(), function (e) {
                            var n;
            ...
            return p.prototype = T.filters = T.pseudos, T.setFilters = new p, k = e.tokenize = function (t, n) {
                ...
                var n, i = [], o = [], r = z[t + " "];
                if (!r) {
                    for (e || (e = k(t)), n = e.length; n--;)r = y(e[n]), r[H] ? i.push(r) : o.push(r);
                ...
                if (n = n || [], 1 === p.length) {
                    if (r = p[0] = p[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && x.getById && 9 === e.nodeType && I && T.relative[r[1].type]) {
                        if (e = (T.find.ID(s.matches[0].replace(xt, Tt), e) || [])[0], !e)return n;
                        u && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = ht.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)if ((l = T.find[a]) && (i = l(s.matches[0].replace(xt, Tt), bt.test(r[0].type) && c(e.parentNode) || e))) {
                        if (r.splice(o, 1), t = i.length && d(r), !t)return K.apply(n, i), n;
                        break
                    }
                }
                return (u || E(t, p))(i, e, !I, n, bt.test(t) && c(e.parentNode) || e), n
            }, x.sortStable = H.split("").sort(V).join("") === H, x.detectDuplicates = !!D, A(), x.sortDetached = o(function (t) {
        ...
        Z.Callbacks = function (t) {
            ...
            Deferred: function (t) {
                ...
                var e, n, i, o = 0, r = B.call(arguments), s = r.length, a = 1 !== s || t && Z.isFunction(t.promise) ? s : 0, l = 1 === a ? t : Z.Deferred(), u = function (t, n, i) {
                    return function (o) {
        ...
        var Et = /^key/, $t = /^(?:mouse|pointer|contextmenu)|click/, St = /^(?:focusinfocus|focusoutblur)$/, Nt = /^([^.]*)(?:\.(.+)|)$/;
        Z.event = {
            global: {},
            add: function (t, e, n, i, o) {
                ...
                }), e = (e || "").match(ft) || [""], u = e.length; u--;)a = Nt.exec(e[u]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (p = Z.event.special[f] || {}, f = (o ? p.delegateType : p.bindType) || f, p = Z.event.special[f] || {}, c = Z.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
            ...
            remove: function (t, e, n, i, o) {
                ...
                if (m && (l = m.events)) {
                    for (e = (e || "").match(ft) || [""], u = e.length; u--;)if (a = Nt.exec(e[u]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
            ...
            trigger: function (e, n, i, o) {
                ...
                if (s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !St.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), u = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), p = Z.event.special[f] || {}, o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
            ...
            dispatch: function (t) {
                t = Z.event.fix(t);
                var e, n, i, o, r, s = [], a = B.call(arguments), l = (vt.get(this, "events") || {})[t.type] || [], u = Z.event.special[t.type] || {};
            ...
            fix: function (t) {
                ...
                for (s || (this.fixHooks[o] = s = $t.test(o) ? this.mouseHooks : Et.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new Z.Event(r), e = i.length; e--;)n = i[e], t[n] = r[n];
        ...
        var Dt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, At = /<([\w:]+)/, qt = /<|&#?\w+;/, Ot = /<(?:script|style|link)/i, It = /checked\s*(?:[^=]|=\s*.checked.)/i, Lt = /^$|\/(?:java|ecma)script/i, Rt = /^true\/(.*)/, _t = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Pt = {
        ...
        Pt.optgroup = Pt.option, Pt.tbody = Pt.tfoot = Pt.colgroup = Pt.caption = Pt.thead, Pt.th = Pt.td, Z.extend({
            clone: function (t, e, n) {
                ...
                for (var o, r, s, a, l, u, c = e.createDocumentFragment(), p = [], d = 0, f = t.length; f > d; d++)if (o = t[d], o || 0 === o)if ("object" === Z.type(o))Z.merge(p, o.nodeType ? [o] : o); else if (qt.test(o)) {
                    for (r = r || c.appendChild(e.createElement("div")), s = (At.exec(o) || ["", ""])[1].toLowerCase(), a = Pt[s] || Pt._default, r.innerHTML = a[1] + o.replace(Dt, "<$1></$2>") + a[2], u = a[0]; u--;)r = r.lastChild;
                    Z.merge(p, r.childNodes), r = c.firstChild, r.textContent = ""
                } else p.push(e.createTextNode(o));
                for (c.textContent = "", d = 0; o = p[d++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(c.appendChild(o), "script"), l && g(r), n))for (u = 0; o = r[u++];)Lt.test(o.type || "") && n.push(o);
                return c
            ...
            text: function (t) {
                ...
                return mt(this, function (t) {
                    ...
                    if ("string" == typeof t && !Ot.test(t) && !Pt[(At.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Dt, "<$1></$2>");
                        try {
                ...
                if (g || u > 1 && "string" == typeof d && !G.checkClone && It.test(d))return this.each(function (n) {
                    var i = c.eq(n);
                ...
                if (u && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    ...
                    if (r)for (a = o[o.length - 1].ownerDocument, Z.map(o, h), l = 0; r > l; l++)s = o[l], Lt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(_t, "")))
                }
                return this
            }
        }), Z.each({
        ...
        var Ht, Ft = {}, Wt = /^margin/, Mt = new RegExp("^(" + xt + ")(?!px)[a-z%]+$", "i"), Bt = function (e) {
        ...
        var Ut = /^(none|table(?!-c[ea]).+)/, zt = new RegExp("^(" + xt + ")(.*)$", "i"), Vt = new RegExp("^([+-])=(" + xt + ")", "i"), Qt = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        }, Xt = {letterSpacing: "0", fontWeight: "400"}, Yt = ["Webkit", "O", "Moz", "ms"];
        Z.extend({
            cssHooks: {
                opacity: {
                    get: function (t, e) {
            ...
            style: function (t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    return e = Z.cssProps[a] || (Z.cssProps[a] = C(l, a)), s = Z.cssHooks[e] || Z.cssHooks[a], void 0 === n ? s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Vt.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(t, e)), r = "number"), void(null != n && n === n && ("number" !== r || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set"in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n))))
                }
            },
            css: function (t, e, n, i) {
                var o, r, s, a = Z.camelCase(e);
                return e = Z.cssProps[a] || (Z.cssProps[a] = C(t.style, a)), s = Z.cssHooks[e] || Z.cssHooks[a], s && "get"in s && (o = s.get(t, !0, n)), void 0 === o && (o = x(t, e, i)), "normal" === o && e in Xt && (o = Xt[e]), "" === n || n ? (r = parseFloat(o), n === !0 || Z.isNumeric(r) ? r || 0 : o) : o
            }
            ...
            Z.cssHooks[e] = {
                get: function (t, n, i) {
                    ...
                    var o = i && Bt(t);
                    return j(t, n, i ? k(t, e, i, "border-box" === Z.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
            ...
            }, Wt.test(t) || (Z.cssHooks[t + e].set = j)
        }), Z.fn.extend({
            css: function (t, e) {
        ...
        var Gt, Jt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + xt + ")([a-z%]*)$", "i"), te = /queueHooks$/, ee = [q], ne = {
            "*": [function (t, e) {
        ...
        var pe = /#.*$/, de = /([?&])_=[^&]*/, fe = /^(.*?):[ \t]*([^\r\n]*)$/gm, he = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ge = /^(?:GET|HEAD)$/, me = /^\/\//, ve = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, ye = {}, be = {}, we = "*/".concat("*"), xe = t.location.href, Te = ve.exec(xe.toLowerCase()) || [];
        Z.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajaxSetup: function (t, e) {
                return e ? _(_(t, Z.ajaxSettings), e) : _(Z.ajaxSettings, t)
            },
            ajaxPrefilter: L(ye),
            ajaxTransport: L(be),
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, c, v, y, w, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", x.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = P(p, x, n)), y = H(p, y, x, l), l ? (p.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (Z.lastModified[o] = w), w = x.getResponseHeader("etag"), w && (Z.etag[o] = w)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, l = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (e || T) + "", l ? h.resolveWith(d, [c, T, x]) : h.rejectWith(d, [x, T, v]), x.statusCode(m), m = void 0, u && f.trigger(l ? "ajaxSuccess" : "ajaxError", [x, p, l ? c : v]), g.fireWith(d, [x, T]), u && (f.trigger("ajaxComplete", [x, p]), --Z.active || Z.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, u, c, p = Z.ajaxSetup({}, e), d = p.context || p, f = p.context && (d.nodeType || d.jquery) ? Z(d) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = p.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled", x = {
                    readyState: 0,
                ...
                if (h.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, p.url = ((t || p.url || xe) + "").replace(pe, "").replace(me, Te[1] + "//"), p.type = e.method || e.type || p.method || p.type, p.dataTypes = Z.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain && (l = ve.exec(p.url.toLowerCase()), p.crossDomain = !(!l || l[1] === Te[1] && l[2] === Te[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (Te[3] || ("http:" === Te[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = Z.param(p.data, p.traditional)), R(ye, p, e, x), 2 === b)return x;
                u = Z.event && p.global, u && 0 === Z.active++ && Z.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !ge.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (ce.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = de.test(o) ? o.replace(de, "$1_=" + ue++) : o + (ce.test(o) ? "&" : "?") + "_=" + ue++)), p.ifModified && (Z.lastModified[o] && x.setRequestHeader("If-Modified-Since", Z.lastModified[o]), Z.etag[o] && x.setRequestHeader("If-None-Match", Z.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || e.contentType) && x.setRequestHeader("Content-Type", p.contentType), x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + we + "; q=0.01" : "") : p.accepts["*"]);
        ...
        Z.ajaxSetup({
            ...
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Oe, "$1" + o) : e.jsonp !== !1 && (e.url += (ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                return s || Z.error(o + " was not called"), s[0]
            }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
                s = arguments
            }, i.always(function () {
                t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, qe.push(o)), s && Z.isFunction(r) && r(s[0]), s = r = void 0
            }), "script") : void 0
        ...
        var Re = t.jQuery, _e = t.$;
        return Z.noConflict = function (e) {
            return t.$ === Z && (t.$ = _e), e && t.jQuery === Z && (t.jQuery = Re), Z
...
var jp_config = {
    ...
    tinymce: ["/bower_components/tinymce/tinymce.jquery.min.js", "/build/js/plugins/tinymce.js"],
