if (!function (t, e) {
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, u, c, p = this, d = {}, f = t.style, h = t.nodeType && Ct(t), m = vt.get(t, "fxshow");
            ...
            if (Z.isEmptyObject(d))"inline" === ("none" === u ? w(t.nodeName) : u) && (f.display = u); else {
                m ? "hidden"in m && (h = m.hidden) : m = vt.access(t, "fxshow", {}), r && (m.hidden = !h), h ? Z(t).show() : p.done(function () {
                    Z(t).hide()
                }), p.done(function () {
                    var e;
                    vt.remove(t, "fxshow");
                ...
                for (i in d)s = A(h ? m[i] : 0, i, p), i in m || (m[i] = s.start, h && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        function I(t, e, n) {
            ...
            for (q(c, u.opts.specialEasing); s > r; r++)if (i = ee[r].call(u, t, c, u.opts))return i;
        ...
        var ot = function (t) {
            function e(t, e, n, i) {
                ...
                if (!i && I) {
                    ...
                    if (x.qsa && (!L || !L.test(t))) {
                        if (f = p = H, h = e, m = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
            ...
            function v(t, e, n, o, r, s) {
                return o && !o[H] && (o = v(o)), r && !r[H] && (r = v(r, s)), i(function (i, s, a, l) {
                    var u, c, p, d = [], f = [], h = s.length, v = i || m(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : g(v, d, t, a, l), b = n ? r || (i ? t : h || o) ? [] : s : y;
                    if (n && n(y, b, a, l), o)for (u = g(b, f), o(u, [], a, l), c = u.length; c--;)(p = u[c]) && (b[f[c]] = !(y[f[c]] = p));
                    if (i) {
                        if (r || t) {
                            if (r) {
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, u) {
                    var c, p, d, f = 0, h = "0", m = i && [], v = [], y = S, b = i || r && T.find.TAG("*", u), w = W += null == y ? 1 : Math.random() || .1, x = b.length;
                    for (u && (S = s !== O && s); h !== x && null != (c = b[h]); h++) {
                        if (r && c) {
            ...
            var w, x, T, C, j, k, E, $, S, N, D, A, O, q, I, L, _, R, P, H = "sizzle" + 1 * new Date, F = t.document, W = 0, M = 0, B = n(), U = n(), z = n(), V = function (t, e) {
                return t === e && (D = !0), 0
            ...
            }, mt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, vt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, wt = /'|\\/g, xt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)", "ig"), Tt = function (t, e, n) {
                var i = "0x" + e - 65536;
            ...
            x = e.support = {}, j = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, q = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), I = !j(i), x.attributes = o(function (t) {
                    return t.className = "i", !t.getAttribute("className")
                }), x.getElementsByTagName = o(function (t) {
                    return t.appendChild(i.createComment("")), !t.getElementsByTagName("*").length
                }), x.getElementsByClassName = vt.test(i.getElementsByClassName), x.getById = o(function (t) {
                    return q.appendChild(t).id = H, !i.getElementsByName || !i.getElementsByName(H).length
                    ...
                    }, _ = [], L = [], (x.qsa = vt.test(i.querySelectorAll)) && (o(function (t) {
                    q.appendChild(t).innerHTML = "<a id='" + H + "'></a><select id='" + H + "-\f]' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && L.push("[*^$]=" + nt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || L.push("\\[" + nt + "*(?:value|" + et + ")"), t.querySelectorAll("[id~=" + H + "-]").length || L.push("~="), t.querySelectorAll(":checked").length || L.push(":checked"), t.querySelectorAll("a#" + H + "+*").length || L.push(".#.+[+~]")
                }), o(function (t) {
                ...
                })), (x.matchesSelector = vt.test(R = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && o(function (t) {
                    x.disconnectedMatch = R.call(t, "div"), R.call(t, "[s!='']:x"), _.push("!=", st)
                }), L = L.length && new RegExp(L.join("|")), _ = _.length && new RegExp(_.join("|")), e = vt.test(q.compareDocumentPosition), P = e || vt.test(q.contains) ? function (t, e) {
                ...
                if ((t.ownerDocument || t) !== O && A(t), n = n.replace(pt, "='$1']"), !(!x.matchesSelector || !I || _ && _.test(n) || L && L.test(n)))try {
                    var i = R.call(t, n);
                ...
                return (t.ownerDocument || t) !== O && A(t), P(t, e)
            }, e.attr = function (t, e) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            if (g) {
                                ...
                                if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (c = g[H] || (g[H] = {}), u = c[t] || [], f = u[0] === W && u[1], d = u[0] === W && u[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (d = f = 0) || h.pop();)if (1 === p.nodeType && ++d && p === e) {
                                        c[t] = [W, f, d];
                                        break
                                    }
                                } else if (y && (u = (e[H] || (e[H] = {}))[t]) && u[0] === W)d = u[1]; else for (; (p = ++f && p && p[m] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[H] || (p[H] = {}))[t] = [W, d]), p !== e)););
        ...
        Z.event = {
            ...
            add: function (t, e, n, i, o) {
                var r, s, a, l, u, c, p, d, f, h, m, g = vt.get(t);
                if (g)for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = Z.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (e) {
                    return typeof Z !== kt && Z.event.triggered !== e.type ? Z.event.dispatch.apply(t, arguments) : void 0
                }), e = (e || "").match(ft) || [""], u = e.length; u--;)a = Nt.exec(e[u]) || [], f = m = a[1], h = (a[2] || "").split(".").sort(), f && (p = Z.event.special[f] || {}, f = (o ? p.delegateType : p.bindType) || f, p = Z.event.special[f] || {}, c = Z.extend({
                    type: f,
                    origType: m,
                    data: i,
                    handler: n,
            ...
            remove: function (t, e, n, i, o) {
                var r, s, a, l, u, c, p, d, f, h, m, g = vt.hasData(t) && vt.get(t);
                if (g && (l = g.events)) {
                    for (e = (e || "").match(ft) || [""], u = e.length; u--;)if (a = Nt.exec(e[u]) || [], f = m = a[1], h = (a[2] || "").split(".").sort(), f) {
                        for (p = Z.event.special[f] || {}, f = (i ? p.delegateType : p.bindType) || f, d = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;)c = d[r], !o && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(r, 1), c.selector && d.delegateCount--, p.remove && p.remove.call(t, c));
                        s && !d.length && (p.teardown && p.teardown.call(t, h, g.handle) !== !1 || Z.removeEvent(t, f, g.handle), delete l[f])
        ...
        var Dt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, At = /<([\w:]+)/, Ot = /<|&#?\w+;/, qt = /<(?:script|style|link)/i, It = /checked\s*(?:[^=]|=\s*.checked.)/i, Lt = /^$|\/(?:java|ecma)script/i, _t = /^true\/(.*)/, Rt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Pt = {
        ...
        Pt.optgroup = Pt.option, Pt.tbody = Pt.tfoot = Pt.colgroup = Pt.caption = Pt.thead, Pt.th = Pt.td, Z.extend({
            clone: function (t, e, n) {
                ...
                if (e)if (n)for (r = r || v(t), s = s || v(a), i = 0, o = r.length; o > i; i++)g(r[i], s[i]); else g(t, a);
                ...
                for (c.textContent = "", d = 0; o = p[d++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(c.appendChild(o), "script"), l && m(r), n))for (u = 0; o = r[u++];)Lt.test(o.type || "") && n.push(o);
                return c
            ...
            text: function (t) {
                ...
                for (var n, i = t ? Z.filter(t, this) : this, o = 0; null != (n = i[o]); o++)e || 1 !== n.nodeType || Z.cleanData(v(n)), n.parentNode && (e && Z.contains(n.ownerDocument, n) && m(v(n, "script")), n.parentNode.removeChild(n));
                return this
            }, empty: function () {
                ...
                return gt(this, function (t) {
                    ...
                    if ("string" == typeof t && !qt.test(t) && !Pt[(At.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Dt, "<$1></$2>");
                        try {
                ...
                t = U.apply([], t);
                var n, i, o, r, s, a, l = 0, u = this.length, c = this, p = u - 1, d = t[0], m = Z.isFunction(d);
                if (m || u > 1 && "string" == typeof d && !G.checkClone && It.test(d))return this.each(function (n) {
                    var i = c.eq(n);
                ...
                if (u && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    ...
                    if (r)for (a = o[o.length - 1].ownerDocument, Z.map(o, h), l = 0; r > l; l++)s = o[l], Lt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Rt, "")))
                }
                return this
            }
        }), Z.each({
