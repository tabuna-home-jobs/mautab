!function (e, t) {
    ...
    lt.event = {
        ...
        function d(e, t) {
            ...
            for (a = e, l = [], c = T.preFilter; a;) {
                ...
                for (r in T.filter)!(i = pt[r].exec(a)) || c[r] && !(i = c[r](i)) || (n = i.shift(), o.push({value: n, type: r, matches: i}), a = a.slice(n.length));
                if (!n)break
            }
    ...
    var un, dn, pn, hn = /alpha\([^)]*\)/i, fn = /opacity\s*=\s*([^)]*)/, mn = /^(top|right|bottom|left)$/, gn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, yn = new RegExp("^(" + ct + ")(.*)$", "i"), bn = new RegExp("^(" + ct + ")(?!px)[a-z%]+$", "i"), wn = new RegExp("^([+-])=(" + ct + ")", "i"), xn = {BODY: "block"}, Cn = {
        ...
        visibility: "hidden",
        display: "block"
    }, kn = {letterSpacing: 0, fontWeight: 400}, Tn = ["Top", "Right", "Bottom", "Left"], En = ["Webkit", "O", "Moz", "ms"];
    lt.fn.extend({
        css: function (e, n) {
    ...
    An = Wn.exec(Mn.toLowerCase()) || [], lt.fn.load = function (e, n, i) {
        ...
        lt[n] = function (e, i, o, r) {
            return lt.isFunction(i) && (r = r || o, o = i, i = t), lt.ajax({url: e, type: n, dataType: r, data: i, success: o})
        }
    }), lt.extend({
        active: 0,
        lastModified: {},
        ...
        ajaxSettings: {
            ...
            accepts: {"*": Un, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"},
        ...
        return s || (s = 0), r.each(function () {
            ...
            switch ("label" == u && l.find("input, textarea, select").length && (r = l.text(), l = l.children().first(), c = l.get(0), u = c.nodeName.toLowerCase()), u) {
                ...
                case"input":
                    ...
                    break;
                case"select":
                    a = {type: "select", name: r || i(c), disabled: !!l.attr("disabled"), selected: l.val(), options: {}}, l.children().each(function () {
    ...
    var s = null, a = !1, l = e(window), c = 0, u = {}, d = {}, p = {}, h = {
        ...
        positionSubmenu: function (t) {
            if (e.ui && e.ui.position)t.css("display", "block").position({my: "left top", at: "right top", of: this, collision: "flipfit fit"}).css("display", ""); else {
        ...
        abortevent: function (e) {
            ...
            i.is(".context-menu-list") || i.closest(".context-menu-list").length || s && s.length || (f.pageX = t.pageX, f.pageY = t.pageY, f.data = t.data, o.on("mousemove.contextMenuShow", g.mousemove), f.timer = setTimeout(function () {
                f.timer = null, o.off("mousemove.contextMenuShow"), s = n, n.trigger(e.Event("contextmenu", {data: f.data, pageX: f.pageX, pageY: f.pageY}))
            }, t.data.delay))
        ...
        show: function (t, n, i) {
            ...
            t.css({position: "absolute", display: "block"}), t.data("width", Math.ceil(t.width()) + 1), t.css({
                position: "static",
                minWidth: "0px",
                maxWidth: "100000px"
            }), t.find("> li > ul").each(function () {
                v.resize(e(this), !0)
            }), n || t.find("ul").andSelf().css({position: "", display: "", minWidth: "", maxWidth: ""}).width(function () {
...
var bootbox = window.bootbox || function (e, t) {
        ...
        d.setLocale = function (e) {
            ...
            return d.dialog(e, [{label: t, icon: u.CANCEL, "class": c.CANCEL, callback: r}, {label: i, icon: u.CONFIRM, "class": c.CONFIRM, callback: s}], {onEscape: r})
        }, d.prompt = function () {
            ...
            }, f = d.dialog(l, [{label: i, icon: u.CANCEL, "class": c.CANCEL, callback: p}, {label: o, icon: u.CONFIRM, "class": c.CONFIRM, callback: h}], {
                header: a,
                show: !1,
                onEscape: p
            });
            ...
            }), t("body").append(k), k.modal({backdrop: "undefined" == typeof o.backdrop ? s : o.backdrop, keyboard: !1, show: !1}), k.on("show", function () {
...
window.bootbox = bootbox, function () {
    ...
    function n(t, n) {
        ...
        function Nt(t) {
            t = e(t);
            var n = t.offset(), i = {left: n.left, right: n.left + t.outerWidth(), top: n.top, bottom: n.top + t.outerHeight()};
            return i
        }
    ...
    e.fn.swipe = function (n) {
        ...
        return i
    }, e.fn.swipe.defaults = _, e.fn.swipe.phases = {PHASE_START: w, PHASE_MOVE: x, PHASE_END: C, PHASE_CANCEL: k}, e.fn.swipe.directions = {
        LEFT: i,
        RIGHT: o,
        UP: r,
        DOWN: s,
        IN: a,
        OUT: l
    }, e.fn.swipe.pageScroll = {NONE: c, HORIZONTAL: g, VERTICAL: v, AUTO: u}, e.fn.swipe.fingers = {ONE: 1, TWO: 2, THREE: 3, ALL: y}
}), !function (e) {
    "use strict";
    function t(e) {
        return function (t) {
    ...
    var n, i, o = e, r = o.document, s = o.navigator, a = o.setTimeout, l = o.encodeURIComponent, c = o.ActiveXObject, u = o.Error, d = o.Number.parseInt || o.parseInt, p = o.Number.parseFloat || o.parseFloat, h = o.Number.isNaN || o.isNaN, f = o.Math.round, m = o.Date.now, g = o.Object.keys, v = o.Object.defineProperty, y = o.Object.prototype.hasOwnProperty, b = o.Array.prototype.slice, w = function () {
        ...
        return {browser: T(s, ["userAgent", "platform", "appName"]), flash: E(P, ["bridge"]), zeroclipboard: {version: At.version, config: At.config()}}
    }, B = function () {
        ...
        if ("boolean" != typeof P.ready && (P.ready = !1), !At.isFlashUnusable() && null === P.bridge) {
            ...
            "number" == typeof e && e >= 0 && a(function () {
                "boolean" != typeof P.deactivated && (P.deactivated = !0), P.deactivated === !0 && At.emit({type: "error", name: "flash-deactivated"})
            }, e), P.overdue = !1, ht()
        }
    }, K = function () {
        ...
        if (n && (e = pt(P.bridge))) {
            var t = $t(n);
            C(e.style, {width: t.width + "px", height: t.height + "px", top: t.top + "px", left: t.left + "px", zIndex: "" + St(z.zIndex)})
        }
    }, _t = function (e) {
    ...
    var It = function (e) {
        var t = this;
        t.id = "" + Mt++, Lt[t.id] = {instance: t, elements: [], handlers: {}}, e && t.clip(e), At.on("*", function (e) {
            return t.emit(e)
    ...
    function o(t) {
        var n = t[0];
        return 9 === n.nodeType ? {width: t.width(), height: t.height(), offset: {top: 0, left: 0}} : e.isWindow(n) ? {
            width: t.width(),
            height: t.height(),
            offset: {top: t.scrollTop(), left: t.scrollLeft()}
        } : n.preventDefault ? {width: 0, height: 0, offset: {top: n.pageY, left: n.pageX}} : {width: t.outerWidth(), height: t.outerHeight(), offset: t.offset()}
    }
    ...
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        start: function (t, n) {
            ...
            i.sortables = [], e(o.connectToSortable).each(function () {
                ...
                n && !n.options.disabled && (i.sortables.push({instance: n, shouldRevert: n.options.revert}), n.refreshPositions(), n._trigger("activate", t, r))
            })
        }, stop: function (t, n) {
