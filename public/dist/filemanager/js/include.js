...
!function (e, a, t) {
    ...
    function y(a, t, n, i, r, o) {
        null !== i && (i = w(i), e.ajax({type: "POST", url: "execute.php?action=" + a, data: {path: t, path_thumb: n, name: i.replace("/", "")}}).done(function (e) {
    ...
    var j = "9.9.2", T = !0, I = 0, O = function () {
        ...
        contextActions: {
            copy_url: function (a) {
                ...
                if ("" != n)if (1 == e("#crossdomain").val())windowParent.postMessage({sender: "responsivefilemanager", url: t, field_id: n}, "*"); else {
            ...
            var a = this;
            e.contextMenu({
                selector: "figure:not(.back-directory), .list-view2 figure:not(.back-directory)", autoHide: !0, build: function (n) {
                    n.addClass("selected");
                    var i = {
                        callback: function (e) {
                    ...
                    return (n.find(".img-precontainer-mini .filetype").hasClass("png") || n.find(".img-precontainer-mini .filetype").hasClass("jpg") || n.find(".img-precontainer-mini .filetype").hasClass("jpeg")) && t && (i.items.edit_img = {
                        ...
                        icon: "copy",
                        disabled: !1
                    }, i.items.cut = {name: e("#lang_cut").val(), icon: "cut", disabled: !1}) : (i.items.copy = {
                        name: e("#lang_copy").val(),
                        icon: "copy",
                        disabled: !1
                    }, i.items.cut = {
                        ...
                        icon: "dimension",
                        disabled: !0
                    }), i.items.size = {name: n.find(".file-size").html(), icon: "size", disabled: !0}, i.items.date = {
    ...
    e(document).ready(function () {
        ...
        e(window).resize(function () {
            ...
            distance: 20, cursor: "move", helper: function () {
            ...
            accept: "ul.grid li", activeClass: "ui-state-highlight", hoverClass: "ui-state-hover", drop: function (a, t) {
