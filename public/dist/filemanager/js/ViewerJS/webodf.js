...
function BrowserRuntime(f) {
    ...
    function d(d) {
        var a = d.length, c = new Uint8Array(new ArrayBuffer(a)), e;
    ...
    function h(b, r, c) {
        if (0 !== c.status || c.responseText)if (200 === c.status || 0 === c.status) {
            if (c.response && "string" !== typeof c.response)"binary" === r ? (c = c.response, c = new Uint8Array(c)) : c = String(c.response); else if ("binary" === r)if (null !== c.responseBody && "undefined" !== String(typeof VBArray)) {
            ...
            c = {err: null, data: c}
        } else c = {err: c.responseText || c.statusText, data: null}; else c = {err: "File " + b + " is empty.", data: null};
        return c
    }
    ...
    this.requestAnimationFrame = function (d) {
        var a = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame, c = 0;
        if (a)a.bind(window), c = a(d); else return setTimeout(d, 15);
        return c
    };
...
function NodeJSRuntime() {
    function f(d) {
        var a = d.length, b, c = new Uint8Array(new ArrayBuffer(a));
    ...
    var a = this, d = require("fs"), b = require("path"), h = "", n, q;
    this.byteArrayFromString = function (a, d) {
        var b = new Buffer(a, d), c, e = b.length, p = new Uint8Array(new ArrayBuffer(e));
...
function RhinoRuntime() {
    var f = this, k = {}, a = k.javax.xml.parsers.DocumentBuilderFactory.newInstance(), d, b, h = "";
    a.setValidating(!1);
    ...
    this.byteArrayFromString = function (a, d) {
        var b, h = a.length, r = new Uint8Array(new ArrayBuffer(h));
        for (b = 0; b < h; b += 1)r[b] =
            a.charCodeAt(b) & 255;
        return r
    };
    ...
    this.loadXML = function (a, b) {
        var h = new k.java.io.File(a), l = null;
        try {
            l = d.parse(h)
        } catch (r) {
    ...
    this.readFile = function (a, d, b) {
        h && (a = h + "/" + a);
        var l = new k.java.io.File(a), r = "binary" === d ? "latin1" : d;
    ...
    this.deleteFile = function (a, d) {
        h && (a = h + "/" + a);
        var b = new k.java.io.File(a), l = a + Math.random(), l = new k.java.io.File(l);
...
(function () {
    function f(a, d, b) {
        var h = a + "/manifest.json", c, e;
        runtime.log("Loading manifest: " + h);
        try {
            c = runtime.readFileSync(h, "utf-8")
        } catch (p) {
            if (b)runtime.log("No loadable manifest found."); else throw console.log(String(p)), p;
            return
        }
        b = JSON.parse(c);
        for (e in b)b.hasOwnProperty(e) && (d[e] = {dir: a, deps: b[e]})
    }
    ...
    var h, n = {core: core, gui: gui, xmldom: xmldom, odf: odf, ops: ops};
    ...
    function k(a) {
        if (a.length) {
            ...
            runtime.readFile(d, "utf8", function (b, h) {
                ...
                var q = "", q = d.lastIndexOf("/"), f = h, q = -1 !== q ? d.substring(0, q) : ".";
    ...
    core.Async = function () {
        return {
            forEach: function (f, k, a) {
                ...
                var b, h = f.length, n = 0;
                for (b = 0; b < h; b += 1)k(f[b], d)
            }, destroyAll: function (f, k) {
                function a(d, b) {
                    if (b)k(b); else if (d < f.length)f[d](function (b) {
                        a(d + 1, b)
                    }); else k()
                }
...
function makeBase64() {
    function f(c) {
        var g, p = c.length, e = new Uint8Array(new ArrayBuffer(p));
        for (g = 0; g < p; g += 1)e[g] = c.charCodeAt(g) & 255;
        return e
    }

    function k(c) {
        var g, p = "", e, a = c.length - 2;
    ...
    function a(c) {
        c = c.replace(/[^A-Za-z0-9+\/]+/g,
            "");
        var p = c.length, e = new Uint8Array(new ArrayBuffer(3 * p)), a = c.length % 4, d = 0, b, I;
    ...
    function d(c) {
        var g, p, e = c.length, a = 0, d = new Uint8Array(new ArrayBuffer(3 * e));
    ...
    function b(c) {
        var g, p, e, a, d = c.length, b = new Uint8Array(new ArrayBuffer(d)), h = 0;
    ...
    var g = function (g) {
        ...
        return c
    }("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), x, t, y = runtime.getWindow(), v, s;
...
core.ByteArrayWriter = function (f) {
    ...
    var a = this, d = 0, b = 1024, h = new Uint8Array(new ArrayBuffer(b));
    ...
    core.DomUtilsImpl = function () {
        ...
        function c(p, g, e) {
            Object.keys(g).forEach(function (a) {
                var d = a.split(":"), b = d[1], h = e(d[0]), d = g[a], f = typeof d;
        ...
        this.splitBoundaries = function (c) {
            ...
            if (c.startContainer.nodeType === Node.TEXT_NODE || c.endContainer.nodeType === Node.TEXT_NODE) {
                ...
                f = c.endOffset;
                g = c.endContainer;
                if (f < g.childNodes.length)for (g = g.childNodes.item(f), f = 0; g.firstChild;)g = g.firstChild; else for (; g.lastChild;)g = g.lastChild, f = g.nodeType === Node.TEXT_NODE ? g.textContent.length : g.childNodes.length;
                g === b && (b = null);
                c.setEnd(g, f);
                f = c.endContainer;
        ...
        this.getNodesInRange = function (c, g, e) {
            var a = [], d = c.commonAncestorContainer, d = d.nodeType === Node.TEXT_NODE ? d.parentNode : d;
            ...
            if (c) {
                c = e.currentNode;
                if (c !== d)for (c = c.parentNode; c && c !== d;)g(c) === NodeFilter.FILTER_REJECT && (e.currentNode = c), c = c.parentNode;
                c = e.currentNode;
                switch (g(c)) {
        ...
        this.rangeContainsNode = function (c, g) {
            var e = g.ownerDocument.createRange(), a = g.ownerDocument.createRange(), d;
        ...
        this.getBoundingClientRect = function (c) {
            var g = c.ownerDocument, a = f(), d = g.body;
            ...
            {left: c.left + d.scrollLeft, right: c.right + d.scrollLeft, top: c.top + d.scrollTop, bottom: c.bottom + d.scrollTop, width: c.width, height: c.height} : c;
            var b;
        ...
        this.mapKeyValObjOntoNode = function (c, g, e) {
            Object.keys(g).forEach(function (a) {
                var d = a.split(":"), b = d[1], d = e(d[0]), h = g[a];
...
core.Cursor = function (f, k) {
    ...
    var b = f.createElementNS("urn:webodf:names:cursor", "cursor"), h = f.createElementNS("urn:webodf:names:cursor", "anchor"), n, q = [], m = f.createRange(), l, r = core.DomUtils;
...
core.EventNotifier = function (f) {
    ...
    this.unsubscribe = function (d, b) {
        ...
        d + '"');
        h = a[d].indexOf(b);
        runtime.assert(-1 !== h, 'tried to unsubscribe unknown callback from event "' + d + '"');
        -1 !== h && a[d].splice(h, 1)
    };
    this.register = k;
    f && f.forEach(k)
...
core.EventSubscriptions = function () {
    function f(d, b, h) {
        d.subscribe(b, h);
        a.push({eventSource: d, eventid: b, callback: h})
    }
    ...
    var a = [], d = new core.EventNotifier, b = {}, h = 0;
    this.addSubscription = f;
    this.addFrameSubscription = function (a, q, k) {
        var l, r, c, e;
        b.hasOwnProperty(q) || (b[q] = []);
        c = b[q];
        for (e = 0; e < c.length; e += 1)if (c[e].eventSource === a) {
            l = c[e];
            break
        }
        l || (r = "s" + h, h += 1, d.register(r), l = {
            frameEventId: r, eventSource: a, task: core.Task.createRedrawTask(function () {
                d.emit(r, void 0)
            })
...
core.NodeFilterChain = function (f) {
    var k = NodeFilter.FILTER_REJECT, a = NodeFilter.FILTER_ACCEPT;
    this.acceptNode = function (d) {
        var b;
        for (b = 0; b < f.length; b += 1)if (f[b].acceptNode(d) === k)return k;
        return a
    }
};
core.PositionIterator = function (f, k, a, d) {
    ...
    function n() {
        var e = r.currentNode, a = e.nodeType;
    ...
    var l = this, r, c, e, p = Node.TEXT_NODE, g = Node.ELEMENT_NODE, x = NodeFilter.FILTER_ACCEPT, t = NodeFilter.FILTER_REJECT;
    this.nextPosition = function () {
        var e = r.currentNode, a = e.nodeType;
        if (e === f)return !1;
        if (0 === c && a === g)null === r.firstChild() && (c = 1);
        else if (a === p && c + 1 < e.length)c += 1; else if (null !== r.nextSibling())c = 0; else if (r.parentNode())c = 1; else return !1;
        return !0
    };
    this.previousPosition = function () {
        var g = !0, e = r.currentNode;
        0 === c ? g = q() : e.nodeType === p ? c -= 1 : null !== r.lastChild() ? n() : e === f ? g = !1 : c = 0;
        return g
    };
    this.previousNode = q;
    this.container = function () {
        var g = r.currentNode, e = g.nodeType;
        0 === c && e !== p && (g = g.parentNode);
        return g
    };
    this.rightNode = function () {
        var a = r.currentNode, d = a.nodeType;
        if (d === p && c === a.length)for (a = a.nextSibling; a && e(a) !== x;)a = a.nextSibling;
        else d === g && 1 === c && (a = null);
        return a
    };
    this.leftNode = function () {
        var a = r.currentNode;
        if (0 === c)for (a = a.previousSibling; a && e(a) !== x;)a = a.previousSibling; else if (a.nodeType === g)for (a = a.lastChild; a && e(a) !== x;)a = a.previousSibling;
        return a
    };
    ...
    this.getPreviousSibling = function () {
        var c =
            r.currentNode, g = r.previousSibling();
        r.currentNode = c;
        return g
    };
    this.getNextSibling = function () {
        var c = r.currentNode, g = r.nextSibling();
        r.currentNode = c;
        return g
    };
...
core.PositionFilterChain = function () {
    var f = [], k = core.PositionFilter.FilterResult.FILTER_ACCEPT, a = core.PositionFilter.FilterResult.FILTER_REJECT;
    this.acceptPosition = function (d) {
        var b;
        for (b = 0; b < f.length; b += 1)if (f[b].acceptPosition(d) === a)return a;
        return k
    };
        ...
        (function (k) {
            ...
            return function a(d, b, h) {
                ...
                1: [function (a, d, b) {
                    ...
                    var f = a("./zlib/inflate.js"), q = a("./utils/common"),
                        m = a("./utils/strings"), l = a("./zlib/constants"), r = a("./zlib/messages"), c = a("./zlib/zstream"), e = a("./zlib/gzheader"), p = function (g) {
                            var a = this.options = q.assign({chunkSize: 16384, windowBits: 0, to: ""}, g || {});
                    ...
                    p.prototype.push = function (c, e) {
                        var a = this.strm, d = this.options.chunkSize, b, p, h, r, z;
                        ...
                        do {
                            ...
                            if (a.next_out && (0 === a.avail_out || b === l.Z_STREAM_END || 0 === a.avail_in && p === l.Z_FINISH))if ("string" === this.options.to)h = m.utf8border(a.output, a.next_out), r = a.next_out - h, z = m.buf2string(a.output, h), a.next_out = r, a.avail_out = d - r, r && q.arraySet(a.output, a.output, h, r, 0), this.onData(z); else this.onData(q.shrinkBuf(a.output, a.next_out))
                    ...
                    "./zlib/messages": 11, "./zlib/zstream": 12
                }], 2: [function (a, d, b) {
                    ...
                    var h = {
                        arraySet: function (a, d, b, h, c) {
                            if (d.subarray && a.subarray)a.set(d.subarray(b, b + h), c); else for (var e = 0; e < h; e++)a[c + e] = d[b + e]
                    ...
                    b.buf2string = function (a, d) {
                        var g, b, f, q, r = d || a.length, l = Array(2 * r);
                        for (g = b = 0; g < r;)if (f = a[g++], 128 > f)l[b++] = f; else if (q = c[f], 4 < q)l[b++] = 65533, g += q - 1; else {
                    ...
                    d.exports = function (a, d, b, f) {
                        b = f + b;
                        for (a ^= -1; f < b; f++)a = a >>> 8 ^ h[(a ^ d[f]) & 255];
                        return a ^ -1
                    }
                }, {}], 7: [function (a, d, b) {
                    d.exports = function () {
                    ...
                    d.exports = function (a, d) {
                        ...
                        a:do b:for (15 > s && (v += G[f++] << s, s += 8, v += G[f++] << s, s += 8), C = w[v & z]; ;) {
                            ...
                            s -= D;
                            D = C >>> 16 & 255;
                            if (0 === D)A[r++] = C & 65535; else if (D & 16) {
                                I = C & 65535;
                    ...
                    var c = a("../utils/common"), e = a("./adler32"), p = a("./crc32"), g = a("./inffast"), x = a("./inftrees"), t = 0, y = -2, v = 1, s = 852, w = 592, u = !0, z, H;
                    b.inflateReset = m;
                    b.inflateReset2 = l;
                    ...
                    b.inflate = function (a, d) {
                        ...
                        E = 0;
                        var B, V, ba, Z, F, X = new c.Buf8(4), R = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                        ...
                        a:for (; ;)switch (b.mode) {
                            case v:
                                ...
                                s -= 4;
                                Q = (m & 15) + 8;
                                if (0 === b.wbits)b.wbits = Q; else if (Q > b.wbits) {
                                ...
                                switch (m & 3) {
                                    ...
                                    case 1:
                                        ...
                                        if (u) {
                                            ...
                                            x(1, E.lens, 0, 288, z, 0, E.work, {bits: 9});
                                            for (Q = 0; 32 > Q;)E.lens[Q++] = 5;
                                            x(2, E.lens,
                                                0, 32, H, 0, E.work, {bits: 5});
                                            u = !1
                                        }
                                        E.lencode = z;
                                        E.lenbits = 9;
                            ...
                            case 19:
                                for (; b.have < b.nlen + b.ndist;) {
                                    ...
                                    if (16 > ba)m >>>= B, s -= B, b.lens[b.have++] = ba; else {
                                        if (16 === ba) {
                                            for (E = B + 2; s < E;) {
                                                if (0 === l)break a;
                                                l--;
                ...
                }, {"../utils/common": 2, "./adler32": 4, "./crc32": 6, "./inffast": 8, "./inftrees": 10}], 10: [function (a,
                                                                                                                           d, b) {
                    var f = a("../utils/common"), n = [3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31, 35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258, 0, 0], q = [16, 16, 16, 16, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 16, 72, 78], m = [1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193, 257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145, 8193, 12289, 16385, 24577, 0, 0], l = [16, 16, 16, 16, 17, 17, 18, 18, 19, 19, 20, 20, 21, 21, 22, 22, 23, 23, 24, 24, 25, 25, 26, 26, 27, 27, 28, 28, 29, 29, 64, 64];
                    d.exports = function (a, c, b, d, g, x, t, y) {
                        ...
                        for (u = 1; u < z && 0 === U[u]; u++);
                        H < u && (H = u);
                        for (s = I = 1; 15 >= s; s++)if (I <<= 1, I -= U[s], 0 > I)return -1;
                ...
                }, {"../utils/common": 2}], 11: [function (a, d, b) {
                    d.exports = {
                        2: "need dictionary",
                        1: "stream end",
                        0: "",
...
core.StepIterator = function (f, k) {
    ...
    function q() {
        for (a(); k.nextPosition();)if (a(), d())return !0;
        return !1
    }

    function m() {
        for (a(); k.previousPosition();)if (a(), d())return !0;
        return !1
    }

    var l = core.PositionFilter.FilterResult.FILTER_ACCEPT, r = core.StepDirection.NEXT,
        c, e, p;
    this.isStep = d;
    this.setPosition = b;
    this.container = h;
...
core.UnitTest.createXmlDocument = function (f, k, a) {
    var d = "<?xml version='1.0' encoding='UTF-8'?>", d = d + ("<" + f);
...
core.UnitTestLogger = function () {
    ...
    this.endTest = function () {
        var h = Date.now();
        return {description: b, suite: [d, b], success: 0 === k, log: f, time: h - a}
    };
    this.debug = function (a) {
        f.push({category: "debug", message: a})
    };
    this.fail = function (a) {
        k += 1;
        f.push({category: "fail", message: a})
    };
    this.pass = function (a) {
        f.push({category: "pass", message: a})
    }
};
core.UnitTestRunner = function (f, k) {
    ...
    function d(c, b) {
        ...
        try {
            ...
            for (e = 0; e < c.length; e += 1)if (c[e] !== b[e])return a(c[e] + " should be " + b[e] + " at array index " + e), !1
        } catch (d) {
            return !1
        }
        return !0
    ...
    function b(c, g, e) {
        var d = c.attributes, f = d.length, h, l, m;
        for (h = 0; h < f; h += 1)if (l = d.item(h), "xmlns" !== l.prefix && "urn:webodf:names:steps" !== l.namespaceURI) {
    ...
    c = function (c, b) {
        var e = Object.keys(c), f = Object.keys(b);
        e.sort();
        f.sort();
...
core.UnitTester = function () {
    ...
    var a = this, d = 0, b = new core.UnitTestLogger, h = {}, n = "BrowserRuntime" === runtime.type();
    this.resourcePrefix = "";
    this.reporter = function (a) {
        ...
        if (!a.success)for (b = 0; b < a.log.length; b +=
    ...
    this.runTests = function (q, m, l) {
        function r(a) {
            ...
            var n, q;
            if (0 === a.length)h[c] = g, d += e.countFailedTests(), m(); else if (t = a[0].f, n = a[0].name, q = !0 === a[0].expectFail, s = e.countFailedTests(), l.length && -1 === l.indexOf(n))r(a.slice(1)); else {
                p.setUp();
                b.startTest(c, n);
                q && e.beginExpectFail();
                try {
        ...
        var c = Runtime.getFunctionName(q) || "", e = new core.UnitTestRunner(a.resourcePrefix, b), p = new q(e), g = {}, x, t, y, v, s;
        if (h.hasOwnProperty(c))runtime.log("Test " + c + " has already run."); else {
            n ? runtime.log("<span>Running " + f(c, 'runSuite("' + c + '");') + ": " + p.description() + "</span>") : runtime.log("Running " + c + ": " + p.description());
            y = p.tests();
            for (x = 0; x < y.length; x += 1)if (t = y[x].f, q = y[x].name, v = !0 === y[x].expectFail, !l.length || -1 !== l.indexOf(q)) {
...
core.Zip = function (f, k) {
    ...
    function n(c, e) {
        ...
        this.load = function (b) {
            if (null !== r.data)b(null, r.data); else {
                var e = h + 34 + d + p + 256;
                e + m > t && (e = t - m);
                a(m, e, function (a, e) {
                    if (a || null === e)b(a, e); else a:{
                        var g = e, d = new core.ByteArray(g), p = d.readUInt32LE(), m;
    ...
    function q(c, b) {
        if (22 !== c.length)b("Central directory length should be 22.", s); else {
            var e = new core.ByteArray(c), d;
            d = e.readUInt32LE();
            101010256 !== d ? b("Central directory signature is wrong: " + d.toString(), s) : (d = e.readUInt16LE(), 0 !== d ? b("Zip files with non-zero disk numbers are not supported.", s) : (d = e.readUInt16LE(), 0 !== d ? b("Zip files with non-zero disk numbers are not supported.", s) : (d = e.readUInt16LE(), y = e.readUInt16LE(), d !== y ? b("Number of entries is inconsistent.", s) : (d = e.readUInt32LE(),
                ...
                if (a || null === c)b(a, s); else a:{
                    var e = new core.ByteArray(c), d, p;
                    g = [];
                    for (d = 0; d < y; d += 1) {
                        p = new n(f, e);
                        if (p.error) {
    ...
    function m(a, c) {
        var b = null, e, d;
        for (d = 0; d < g.length; d += 1)if (e = g[d], e.filename === a) {
            b = e;
            break
        }
    ...
    function l(a) {
        var c = new core.ByteArrayWriter("utf8"), b = 0;
    ...
    function e(a, b) {
        c(0, function (c) {
            if (c)b(c); else {
                var e, d, p = new core.ByteArrayWriter("utf8"), f = [0];
    ...
    var g, x, t, y, v = core.RawInflate.inflate, s = this, w = new core.Base64;
    this.load = m;
    this.save = function (a, c, b, e) {
        var d, p;
        for (d = 0; d < g.length; d += 1)if (p = g[d], p.filename === a) {
            p.set(a, c, b, e);
            return
        }
        p = new n(f);
    ...
    this.remove = function (a) {
        var c, b;
        for (c = 0; c < g.length; c += 1)if (b = g[c], b.filename ===
    ...
    null === k ? g = [] : runtime.readFile(f, "binary", function (c, b) {
        "string" === typeof b && (c = "file was read as a string. Should be Uint8Array.");
...
gui.SessionConstraints = function () {
    ...
    var k = {}, a = new core.EventNotifier;
...
gui.BlacklistNamespaceNodeFilter = function (f) {
    var k = {}, a = NodeFilter.FILTER_REJECT, d = NodeFilter.FILTER_ACCEPT;
...
(function () {
    var f = odf.Namespaces.namespaceMap, k = odf.Namespaces.prefixMap, a;
    for (a in f)f.hasOwnProperty(a) && (k[f[a]] = a)
})();
odf.Namespaces.forEachPrefix = function (f) {
    var k = odf.Namespaces.namespaceMap, a;
...
odf.OdfUtilsImpl = function () {
    ...
    function s(a) {
        for (var b = !1; a;)if (a.nodeType ===
            Node.TEXT_NODE)if (0 === a.length)a = y(a); else return !q(a.data.substr(a.length - 1, 1)); else c(a) ? (b = !1 === e(a), a = null) : a = y(a);
        return b
    }
    ...
    function K(b, e, g) {
        ...
        d = U.getNodesInRange(b, function (b) {
                ...
                if (r(b.parentNode) || l(b.parentNode) || a(b))e = NodeFilter.FILTER_REJECT; else if (b.nodeType === Node.TEXT_NODE) {
                    if (g || Boolean(h(b) && (!q(b.textContent) || z(b, 0))))e = NodeFilter.FILTER_ACCEPT
                } else if (c(b))e = NodeFilter.FILTER_ACCEPT; else if (I(b) || m(b))e = NodeFilter.FILTER_SKIP;
                return e
            },
    ...
    var Y = odf.Namespaces.textns, T = odf.Namespaces.drawns, J = odf.Namespaces.xlinkns, U = core.DomUtils, aa = [odf.Namespaces.dbns, odf.Namespaces.dcns, odf.Namespaces.dr3dns, odf.Namespaces.drawns,
        odf.Namespaces.chartns, odf.Namespaces.formns, odf.Namespaces.numberns, odf.Namespaces.officens, odf.Namespaces.presentationns, odf.Namespaces.stylens, odf.Namespaces.svgns, odf.Namespaces.tablens, odf.Namespaces.textns], P = odf.OdfSchema;
    this.isImage = f;
    ...
    this.getParagraphElements = function (a) {
        ...
        c = U.getNodesInRange(a, function (a) {
            var c = NodeFilter.FILTER_REJECT;
            if (b(a))c = NodeFilter.FILTER_ACCEPT; else if (I(a) || m(a))c = NodeFilter.FILTER_SKIP;
            return c
...
gui.OdfTextBodyNodeFilter = function () {
    var f = odf.OdfUtils, k = Node.TEXT_NODE, a = NodeFilter.FILTER_REJECT, d = NodeFilter.FILTER_ACCEPT, b = odf.Namespaces.textns;
...
function createXPathSingleton() {
    ...
    return {
        getODFElementsWithXPath: function (b, c, e) {
            var d = b.ownerDocument, g = [], f = null;
            if (d && "function" === typeof d.evaluate)for (e = d.evaluate(c, b, e, XPathResult.UNORDERED_NODE_ITERATOR_TYPE, null), f = e.iterateNext(); null !== f;)f.nodeType === Node.ELEMENT_NODE && g.push(f), f = e.iterateNext(); else {
                g =
                    new a;
                g.setNode(b);
                b = k(c);
...
odf.StyleInfo = function () {
    function f(a, b) {
        var c, e, d, g, p, h = 0;
        if (c = C[a.localName])if (d = c[a.namespaceURI])h = d.length;
    ...
    function k(a, b) {
        var c, e, d, g, f, p = 0;
        if (c = C[a.localName])if (d = c[a.namespaceURI])p = d.length;
        for (c = 0; c < p; c += 1)if (e = d[c], g = e.ns, f = e.localname, e = a.getAttributeNS(g, f))e = e.replace(b, ""), a.setAttributeNS(g, z[g] + f, e);
    ...
    function a(a, b) {
        var c, e, d, g, f, p = 0;
        if (c = C[a.localName])if (d = c[a.namespaceURI])p = d.length;
        for (c = 0; c < p; c += 1)if (g = d[c], e = g.ns, f = g.localname, e = a.getAttributeNS(e, f))b = b || {}, g = g.keyname, b.hasOwnProperty(g) ? b[g][e] = 1 : (f = {}, f[e] = 1, b[g] = f);
        return b
    }
    ...
    function n(a, b, c) {
        ...
        e && f && (b = h(e, f, c));
        if (b) {
            if (e = C[a.localName])if (g = e[a.namespaceURI])l = g.length;
            for (e = 0; e < l; e += 1)if (f = g[e], d = f.ns, p = f.localname, d = a.getAttributeNS(d, p))f = f.keyname, f = h(d, f, c), b.requires[f.key] = f
        }
    ...
    function l(a, b) {
        ...
        var e = ["font-name", "font-name-asian", "font-name-complex"], d, g;
    ...
    var c = odf.Namespaces.chartns, e = odf.Namespaces.dbns, p = odf.Namespaces.dr3dns, g = odf.Namespaces.drawns, x = odf.Namespaces.formns, t = odf.Namespaces.numberns, y = odf.Namespaces.officens, v = odf.Namespaces.presentationns, s = odf.Namespaces.stylens, w = odf.Namespaces.tablens, u = odf.Namespaces.textns, z = {
        ...
        text: [{ens: s, en: "tab-stop", ans: s, a: "leader-text-style"}, {ens: s, en: "drop-cap", ans: s, a: "style-name"}, {
            ens: u,
            en: "notes-configuration",
            ans: u,
            a: "citation-body-style-name"
        }, {ens: u, en: "notes-configuration", ans: u, a: "citation-style-name"}, {ens: u, en: "a", ans: u, a: "style-name"}, {
            ens: u,
            ...
            ans: u, a: "style-name"
        }, {ens: u, en: "list-level-style-number", ans: u, a: "style-name"}, {ens: u, en: "ruby-text", ans: u, a: "style-name"}, {
            ens: u,
            en: "span",
            ans: u,
            a: "style-name"
        }, {ens: u, en: "a", ans: u, a: "visited-style-name"}, {ens: s, en: "text-properties", ans: s, a: "text-line-through-text-style"}, {
            ens: u,
            en: "alphabetical-index-source",
            ans: u,
            a: "main-entry-style-name"
        }, {ens: u, en: "index-entry-bibliography", ans: u, a: "style-name"}, {ens: u, en: "index-entry-chapter", ans: u, a: "style-name"}, {
            ens: u,
            en: "index-entry-link-end",
            ans: u,
            a: "style-name"
        },
            {ens: u, en: "index-entry-link-start", ans: u, a: "style-name"}, {ens: u, en: "index-entry-page-number", ans: u, a: "style-name"}, {
                ens: u,
                en: "index-entry-span",
                ans: u,
                a: "style-name"
            }, {ens: u, en: "index-entry-tab-stop", ans: u, a: "style-name"}, {ens: u, en: "index-entry-text", ans: u, a: "style-name"}, {
                ens: u,
                en: "index-title-template",
                ans: u,
                a: "style-name"
            }, {ens: u, en: "list-level-style-bullet", ans: u, a: "style-name"}, {ens: u, en: "outline-level-style", ans: u, a: "style-name"}],
        paragraph: [{ens: g, en: "caption", ans: g, a: "text-style-name"}, {
            ens: g,
            en: "circle", ans: g, a: "text-style-name"
        }, {ens: g, en: "connector", ans: g, a: "text-style-name"}, {ens: g, en: "control", ans: g, a: "text-style-name"}, {
            ens: g,
            en: "custom-shape",
            ans: g,
            a: "text-style-name"
        }, {ens: g, en: "ellipse", ans: g, a: "text-style-name"}, {ens: g, en: "frame", ans: g, a: "text-style-name"}, {
            ens: g,
            en: "line",
            ans: g,
            a: "text-style-name"
        }, {ens: g, en: "measure", ans: g, a: "text-style-name"}, {ens: g, en: "path", ans: g, a: "text-style-name"}, {
            ens: g,
            en: "polygon",
            ans: g,
            a: "text-style-name"
        }, {ens: g, en: "polyline", ans: g, a: "text-style-name"},
            {ens: g, en: "rect", ans: g, a: "text-style-name"}, {ens: g, en: "regular-polygon", ans: g, a: "text-style-name"}, {
                ens: y,
                en: "annotation",
                ans: g,
                a: "text-style-name"
            }, {ens: x, en: "column", ans: x, a: "text-style-name"}, {ens: s, en: "style", ans: s, a: "next-style-name"}, {
                ens: w,
                en: "body",
                ans: w,
                a: "paragraph-style-name"
            }, {ens: w, en: "even-columns", ans: w, a: "paragraph-style-name"}, {ens: w, en: "even-rows", ans: w, a: "paragraph-style-name"}, {
                ens: w,
                en: "first-column",
                ans: w,
                a: "paragraph-style-name"
            }, {ens: w, en: "first-row", ans: w, a: "paragraph-style-name"},
            {ens: w, en: "last-column", ans: w, a: "paragraph-style-name"}, {ens: w, en: "last-row", ans: w, a: "paragraph-style-name"}, {
                ens: w,
                en: "odd-columns",
                ans: w,
                a: "paragraph-style-name"
            }, {ens: w, en: "odd-rows", ans: w, a: "paragraph-style-name"}, {ens: u, en: "notes-configuration", ans: u, a: "default-style-name"}, {
                ens: u,
                en: "alphabetical-index-entry-template",
                ans: u,
                a: "style-name"
            }, {ens: u, en: "bibliography-entry-template", ans: u, a: "style-name"}, {ens: u, en: "h", ans: u, a: "style-name"}, {
                ens: u,
                en: "illustration-index-entry-template",
                ans: u,
                a: "style-name"
            },
            {ens: u, en: "index-source-style", ans: u, a: "style-name"}, {ens: u, en: "object-index-entry-template", ans: u, a: "style-name"}, {
                ens: u,
                en: "p",
                ans: u,
                a: "style-name"
            }, {ens: u, en: "table-index-entry-template", ans: u, a: "style-name"}, {ens: u, en: "table-of-content-entry-template", ans: u, a: "style-name"}, {
                ens: u,
                en: "table-index-entry-template",
                ans: u,
                a: "style-name"
            }, {ens: u, en: "user-index-entry-template", ans: u, a: "style-name"}, {ens: s, en: "page-layout-properties", ans: s, a: "register-truth-ref-style-name"}],
        chart: [{
            ens: c, en: "axis", ans: c,
            a: "style-name"
        }, {ens: c, en: "chart", ans: c, a: "style-name"}, {ens: c, en: "data-label", ans: c, a: "style-name"}, {
            ens: c,
            en: "data-point",
            ans: c,
            a: "style-name"
        }, {ens: c, en: "equation", ans: c, a: "style-name"}, {ens: c, en: "error-indicator", ans: c, a: "style-name"}, {
            ens: c,
            en: "floor",
            ans: c,
            a: "style-name"
        }, {ens: c, en: "footer", ans: c, a: "style-name"}, {ens: c, en: "grid", ans: c, a: "style-name"}, {ens: c, en: "legend", ans: c, a: "style-name"}, {
            ens: c,
            en: "mean-value",
            ans: c,
            a: "style-name"
            ...
            ans: c, a: "style-name"
        }, {ens: c, en: "series", ans: c, a: "style-name"}, {ens: c, en: "stock-gain-marker", ans: c, a: "style-name"}, {
            ens: c,
            en: "stock-loss-marker",
            ans: c,
            a: "style-name"
        }, {ens: c, en: "stock-range-line", ans: c, a: "style-name"}, {ens: c, en: "subtitle", ans: c, a: "style-name"}, {
            ens: c,
            en: "title",
            ans: c,
            a: "style-name"
        }, {ens: c, en: "wall", ans: c, a: "style-name"}],
        section: [{ens: u, en: "alphabetical-index", ans: u, a: "style-name"}, {ens: u, en: "bibliography", ans: u, a: "style-name"}, {
            ens: u,
            en: "illustration-index",
            ans: u,
            a: "style-name"
        },
            {ens: u, en: "index-title", ans: u, a: "style-name"}, {ens: u, en: "object-index", ans: u, a: "style-name"}, {
                ens: u,
                en: "section",
                ans: u,
                a: "style-name"
            }, {ens: u, en: "table-of-content", ans: u, a: "style-name"}, {ens: u, en: "table-index", ans: u, a: "style-name"}, {
                ens: u,
                en: "user-index",
                ans: u,
                a: "style-name"
        ...
        table: [{ens: e, en: "query", ans: e, a: "style-name"}, {ens: e, en: "table-representation", ans: e, a: "style-name"}, {
            ens: w,
            en: "background",
            ans: w,
            a: "style-name"
        }, {ens: w, en: "table", ans: w, a: "style-name"}],
        "table-column": [{ens: e, en: "column", ans: e, a: "style-name"}, {ens: w, en: "table-column", ans: w, a: "style-name"}],
        "table-row": [{ens: e, en: "query", ans: e, a: "default-row-style-name"}, {ens: e, en: "table-representation", ans: e, a: "default-row-style-name"}, {
            ens: w,
            en: "table-row",
            ans: w,
            a: "style-name"
        }],
        "table-cell": [{ens: e, en: "column", ans: e, a: "default-cell-style-name"}, {ens: w, en: "table-column", ans: w, a: "default-cell-style-name"}, {
            ens: w,
            en: "table-row",
            ans: w,
            a: "default-cell-style-name"
        }, {ens: w, en: "body", ans: w, a: "style-name"},
            {ens: w, en: "covered-table-cell", ans: w, a: "style-name"}, {ens: w, en: "even-columns", ans: w, a: "style-name"}, {
                ens: w,
                en: "covered-table-cell",
                ans: w,
                a: "style-name"
            }, {ens: w, en: "even-columns", ans: w, a: "style-name"}, {ens: w, en: "even-rows", ans: w, a: "style-name"}, {
                ens: w,
                en: "first-column",
                ans: w,
                a: "style-name"
            }, {ens: w, en: "first-row", ans: w, a: "style-name"}, {ens: w, en: "last-column", ans: w, a: "style-name"}, {
                ens: w,
                en: "last-row",
                ans: w,
                a: "style-name"
            }, {ens: w, en: "odd-columns", ans: w, a: "style-name"}, {ens: w, en: "odd-rows", ans: w, a: "style-name"},
            {ens: w, en: "table-cell", ans: w, a: "style-name"}],
        graphic: [{ens: p, en: "cube", ans: g, a: "style-name"}, {ens: p, en: "extrude", ans: g, a: "style-name"}, {
            ens: p,
            en: "rotate",
            ans: g,
            a: "style-name"
        }, {ens: p, en: "scene", ans: g, a: "style-name"}, {ens: p, en: "sphere", ans: g, a: "style-name"}, {ens: g, en: "caption", ans: g, a: "style-name"}, {
            ens: g,
            en: "circle",
            ans: g,
            a: "style-name"
        }, {ens: g, en: "connector", ans: g, a: "style-name"}, {ens: g, en: "control", ans: g, a: "style-name"}, {
            ens: g,
            en: "custom-shape",
            ans: g,
            a: "style-name"
        }, {ens: g, en: "ellipse", ans: g, a: "style-name"},
            {ens: g, en: "frame", ans: g, a: "style-name"}, {ens: g, en: "g", ans: g, a: "style-name"}, {ens: g, en: "line", ans: g, a: "style-name"}, {
                ens: g,
                en: "measure",
                ans: g,
                a: "style-name"
            }, {ens: g, en: "page-thumbnail", ans: g, a: "style-name"}, {ens: g, en: "path", ans: g, a: "style-name"}, {
                ens: g,
                en: "polygon",
                ans: g,
                a: "style-name"
            }, {ens: g, en: "polyline", ans: g, a: "style-name"}, {ens: g, en: "rect", ans: g, a: "style-name"}, {
                ens: g,
                en: "regular-polygon",
                ans: g,
                a: "style-name"
            }, {ens: y, en: "annotation", ans: g, a: "style-name"}],
        presentation: [{
            ens: p, en: "cube", ans: v,
            a: "style-name"
        }, {ens: p, en: "extrude", ans: v, a: "style-name"}, {ens: p, en: "rotate", ans: v, a: "style-name"}, {ens: p, en: "scene", ans: v, a: "style-name"}, {
            ens: p,
            en: "sphere",
            ans: v,
            a: "style-name"
        }, {ens: g, en: "caption", ans: v, a: "style-name"}, {ens: g, en: "circle", ans: v, a: "style-name"}, {ens: g, en: "connector", ans: v, a: "style-name"}, {
            ens: g,
            en: "control",
            ans: v,
            a: "style-name"
        }, {ens: g, en: "custom-shape", ans: v, a: "style-name"}, {ens: g, en: "ellipse", ans: v, a: "style-name"}, {
            ens: g,
            en: "frame",
            ans: v,
            a: "style-name"
        }, {ens: g, en: "g", ans: v, a: "style-name"},
            {ens: g, en: "line", ans: v, a: "style-name"}, {ens: g, en: "measure", ans: v, a: "style-name"}, {
                ens: g,
                en: "page-thumbnail",
                ans: v,
                a: "style-name"
            }, {ens: g, en: "path", ans: v, a: "style-name"}, {ens: g, en: "polygon", ans: v, a: "style-name"}, {
                ens: g,
                en: "polyline",
                ans: v,
                a: "style-name"
            }, {ens: g, en: "rect", ans: v, a: "style-name"}, {ens: g, en: "regular-polygon", ans: v, a: "style-name"}, {
                ens: y,
                en: "annotation",
                ans: v,
                a: "style-name"
            }],
        "drawing-page": [{ens: g, en: "page", ans: g, a: "style-name"}, {ens: v, en: "notes", ans: g, a: "style-name"}, {
            ens: s, en: "handout-master",
            ans: g, a: "style-name"
        }, {ens: s, en: "master-page", ans: g, a: "style-name"}],
        "list-style": [{ens: u, en: "list", ans: u, a: "style-name"}, {ens: u, en: "numbered-paragraph", ans: u, a: "style-name"}, {
            ens: u,
            en: "list-item",
            ans: u,
            a: "style-override"
        }, {ens: s, en: "style", ans: s, a: "list-style-name"}],
        data: [{ens: s, en: "style", ans: s, a: "data-style-name"}, {ens: s, en: "style", ans: s, a: "percentage-data-style-name"}, {
            ens: v,
            en: "date-time-decl",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "creation-date", ans: s, a: "data-style-name"}, {
            ens: u, en: "creation-time",
            ans: s, a: "data-style-name"
        }, {ens: u, en: "database-display", ans: s, a: "data-style-name"}, {ens: u, en: "date", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "editing-duration",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "expression", ans: s, a: "data-style-name"}, {ens: u, en: "meta-field", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "modification-date",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "modification-time", ans: s, a: "data-style-name"}, {ens: u, en: "print-date", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "print-time",
            ans: s,
            a: "data-style-name"
        ...
        }, {ens: u, en: "time", ans: s, a: "data-style-name"}, {ens: u, en: "user-defined", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "user-field-get",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "user-field-input", ans: s, a: "data-style-name"}, {ens: u, en: "variable-get", ans: s, a: "data-style-name"}, {
            ens: u,
            en: "variable-input",
            ans: s,
            a: "data-style-name"
        }, {ens: u, en: "variable-set", ans: s, a: "data-style-name"}],
        "page-layout": [{ens: v, en: "notes", ans: s, a: "page-layout-name"}, {
    ...
    this.getStyleName = function (a, b) {
        ...
        if (d && (d = d[b.namespaceURI]))for (e = 0; e < d.length; e +=
            1)if (d[e].keyname === a && (d = d[e], b.hasAttributeNS(d.ns, d.localname))) {
        ...
        if (a) {
            for (e = a.firstChild; e;) {
                if (e.nodeType === Node.ELEMENT_NODE) {
                    var d = e, p = b, h = d.getAttributeNS(g, "name"), l = void 0;
        ...
        if (a) {
            for (b = a.firstChild; b;) {
                if (b.nodeType === Node.ELEMENT_NODE) {
                    var d = b, f = e, p = d.getAttributeNS(g, "name"), h = void 0;
    ...
    C = function () {
        var a, b, c, e, d, g = {}, f, p,
            h, l;
        for (c in H)if (H.hasOwnProperty(c))for (e = H[c], b = e.length, a = 0; a < b; a += 1)d = e[a], h = d.en, l = d.ens, g.hasOwnProperty(h) ? f = g[h] : g[h] = f = {}, f.hasOwnProperty(l) ? p = f[l] : f[l] = p = [], p.push({
            ns: d.ans,
            localname: d.a,
            keyname: c
        });
...
xmldom.LSSerializer = function () {
    ...
    function a(b, f) {
        var n = "", q = d.filter ? d.filter.acceptNode(f) : NodeFilter.FILTER_ACCEPT, m;
        if (q === NodeFilter.FILTER_ACCEPT && f.nodeType === Node.ELEMENT_NODE) {
            b.push();
            m = b.getQName(f);
            var l, r = f.attributes, c, e, p, g = "", x;
            l = "<" + m;
            c = r.length;
...
(function () {
    function f(a) {
        var b, e = q.length;
        for (b = 0; b < e; b += 1)if ("urn:oasis:names:tc:opendocument:xmlns:office:1.0" === a.namespaceURI && a.localName === q[b])return b;
        return -1
    }

    function k(a, c) {
        var e = new b.UsedStyleList(a, c), d = new odf.OdfNodeFilter;
    ...
    var b = new odf.StyleInfo, h = core.DomUtils, n = odf.Namespaces.stylens, q = "meta settings scripts font-face-decls styles automatic-styles master-styles body".split(" "),
        m = Date.now() + "_webodf_", l = new core.Base64;
    ...
    odf.OdfContainer = function c(e, f) {
        ...
        function q(a) {
            var b = {}, c, e, d = a.ownerDocument.createNodeIterator(a, NodeFilter.SHOW_ELEMENT, null, !1);
        ...
        function s(a, b) {
            var c = null, e, d, g;
            if (a)for (c = a.cloneNode(!0), e = c.firstElementChild; e;)d = e.nextElementSibling, (g = e.getAttributeNS("urn:webodf:names:scope", "scope")) && g !== b && c.removeChild(e), e = d;
            return c
        }
        ...
        function u(a) {
            var b = F.rootElement.ownerDocument, c;
            if (a) {
                g(a.documentElement);
                try {
            ...
            if (a && "document-content" === a.localName && "urn:oasis:names:tc:opendocument:xmlns:office:1.0" === a.namespaceURI) {
                ...
                if (e.fontFaceDecls && f) {
                    ...
                    for (f = f.firstElementChild; f;) {
                        ...
                        if (f.namespaceURI === n && "font-face" === f.localName)if (m = f.getAttributeNS(n,
                ...
                if (e.automaticStyles && g)for (p =
                                                    g.firstChild; p;)e.automaticStyles.appendChild(p), p = g.firstChild; else g && (e.automaticStyles = g, d(e, g));
        ...
        function Y(a) {
            var b = a.firstElementChild, c = [], e, d, g, f = a.attributes, p = f.length;
        ...
        function P() {
            var a = runtime.parseXML('<manifest:manifest xmlns:manifest="urn:oasis:names:tc:opendocument:xmlns:manifest:1.0" manifest:version="1.2"></manifest:manifest>'), b = a.documentElement, c = new xmldom.LSSerializer, e;
        ...
        function E() {
            var a, c, e, d = odf.Namespaces.namespaceMap,
                g = new xmldom.LSSerializer, f = J("document-styles");
        ...
        function Q() {
            var b, c, e = odf.Namespaces.namespaceMap, d = new xmldom.LSSerializer, g = J("document-content");
        ...
        function V(a, b) {
            ...
            var d = new core.Zip("", null), g = "application/vnd.oasis.opendocument." +
                a + (!0 === b ? "-template" : ""), f = runtime.byteArrayFromString(g, "utf8"), p = F.rootElement, h = document.createElementNS("urn:oasis:names:tc:opendocument:xmlns:office:1.0", a);
        ...
        this.incrementEditingCycles = function () {
            ...
            isNaN(a) && (a = 0);
            B({"meta:editing-cycles": a + 1}, null);
            return a + 1
        };
        ...
        e === odf.OdfContainer.DocumentType.TEXT ? X = V("text") : e === odf.OdfContainer.DocumentType.TEXT_TEMPLATE ? X = V("text", !0) : e === odf.OdfContainer.DocumentType.PRESENTATION ? X = V("presentation") : e === odf.OdfContainer.DocumentType.PRESENTATION_TEMPLATE ? X = V("presentation", !0) : e === odf.OdfContainer.DocumentType.SPREADSHEET ? X = V("spreadsheet") :
            e === odf.OdfContainer.DocumentType.SPREADSHEET_TEMPLATE ? X = V("spreadsheet", !0) : (S = e, X = new core.Zip(S, function (a, b) {
                ...
                a ? $(S, function (b) {
                    a && (X.error = a + "\n" + b, z(c.INVALID))
                }) : T([{path: "styles.xml", handler: C}, {path: "content.xml", handler: D}, {path: "meta.xml", handler: I}, {
                    path: "settings.xml",
                    handler: N
                }, {path: "META-INF/manifest.xml", handler: K}])
            }))
    };
...
gui.AnnotationViewManager = function (f, k, a, d) {
    function b(a) {
        var b = a.annotationEndElement, c = l.createRange(), d = a.getAttributeNS(odf.Namespaces.officens, "name");
    ...
    function q() {
        ...
        for (b = 0; b < m.length; b += 1) {
            var c = m[b], e = c.parentNode,
                d = e.nextElementSibling, h = d.nextElementSibling, l = e.parentNode, q = 0, q = m[m.indexOf(c) - 1], n = void 0, c = f.getZoomLevel();
            ...
            c + "px";
            var d = h.style, l = h.getBoundingClientRect().left / c, q = h.getBoundingClientRect().top / c, n = e.getBoundingClientRect().left / c, k = e.getBoundingClientRect().top / c, r = 0, H = 0, r = n - l, r = r * r, H = k - q, H = H * H, l = Math.sqrt(r + H);
            d.width = l + "px";
    ...
    var m = [], l = k.ownerDocument,
        r = odf.OdfUtils, c = runtime.getWindow(), e = "http://www.w3.org/1999/xhtml";
    ...
    this.addAnnotation =
        function (a) {
            ...
            m.push(a);
            n();
            var c = l.createElement("div"), e = l.createElement("div"), f = l.createElement("div"), k = l.createElement("div"), v;
    ...
    this.forgetAnnotations = function () {
        for (; m.length;) {
            var a = m[0], b = m.indexOf(a), c = a.parentNode.parentNode;
...
gui.SingleScrollViewport = function (f) {
    this.scrollIntoView = function (k, a) {
        ...
        if (k && q) {
            ...
            h = q.right - (h + 5);
            n = q.bottom - (n + 5);
            if (a || k.top < b)f.scrollTop -= b - k.top; else if (k.top > n || k.bottom > n)f.scrollTop = k.bottom - k.top <= n - b ? f.scrollTop + (k.bottom - n) : f.scrollTop + (k.top - b);
...
(function () {
    ...
    var k = xmldom.XPath, a = odf.OdfUtils, d = new core.Base64;
    odf.FontLoader = function () {
        this.loadFonts = function (b, d) {
            ...
            if (n) {
                var q = {}, m, l, r, c;
                if (n)for (n = k.getODFElementsWithXPath(n, "style:font-face[svg:font-face-src]", odf.Namespaces.lookupNamespaceURI), m = 0; m < n.length; m += 1)l = n[m], r = l.getAttributeNS(odf.Namespaces.stylens, "name"), c = a.getNormalizedFontFamilyName(l.getAttributeNS(odf.Namespaces.svgns,
...
odf.Formatting = function () {
    ...
    function k() {
        for (var a = c.rootElement.fontFaceDecls, b = {}, e, d, a = a && a.firstElementChild; a;) {
            if (e = a.getAttributeNS(g, "name"))if ((d = a.getAttributeNS(p, "font-family")) || 0 < a.getElementsByTagNameNS(p, "font-face-uri").length)b[e] = d;
            a = a.nextElementSibling
        }
        return b
    }
    ...
    function d(a, b, e) {
        ...
        for (p = 0; p < e.length; p += 1)for (d = e[p], d = d.firstElementChild; d;) {
    ...
    function q(a) {
        ...
        a.forEach(function (a) {
            Object.keys(a).forEach(function (e) {
                var f = Object.keys(a[e])[0], p = {name: f, family: e, displayName: void 0, isCommonStyle: !1}, l;
    ...
    var c, e = new odf.StyleInfo, p = odf.Namespaces.svgns, g = odf.Namespaces.stylens, x = odf.Namespaces.textns, t = odf.Namespaces.numberns, y = odf.Namespaces.fons, v = odf.OdfUtils, s = core.DomUtils, w = new core.Utils, u = new core.CSSUnits, z = {paragraph: {"style:paragraph-properties": {"fo:text-align": "left"}}};
    ...
    this.getFirstCommonParentStyleNameOrSelf = function (a) {
        var b = c.rootElement.styles, e;
        if (e = d(a, "paragraph", [c.rootElement.automaticStyles]))if (a = e.getAttributeNS(g, "parent-style-name"), !a)return null;
    ...
    this.createDerivedStyleObject = function (a, e,
        ...
        a = f.parentNode === c.rootElement.styles ? {"style:parent-style-name": a} : b(f);
        a["style:family"] = e;
        w.mergeObjects(a, g);
        return a
    };
    ...
    this.getContentSize = function (a, b) {
        ...
        a:{
            ...
            if (f) {
                ...
                if (e)for (f = e.getAttributeNS(g, "page-layout-name"), p = c.rootElement.automaticStyles.getElementsByTagNameNS(g,
                    "page-layout"), h = 0; h < p.length; h += 1)if (e = p.item(h), e.getAttributeNS(g, "name") === f)break a
            }
            e = null
        }
        ...
        return {width: f - h - m - k - x, height: p - q - n - t - e}
    }
};
(function () {
    var f = odf.Namespaces.stylens, k = odf.Namespaces.textns, a = {
        graphic: "draw",
        "drawing-page": "draw",
        paragraph: "text",
...
(function () {
    ...
    function a(a) {
        function b(e, d, q, n) {
            var k = d.namespaceURI === h && "list" === d.localName, r = d.namespaceURI === h && "list-item" === d.localName;
            if (k || r) {
                if (k) {
                    var k = q += 1, s, w, u;
    ...
    var d = odf.Namespaces.fons, b = odf.Namespaces.stylens, h = odf.Namespaces.textns, n = odf.Namespaces.xmlns, q = {
        1: "decimal",
        a: "lower-latin",
        A: "upper-latin",
        i: "lower-roman",
    ...
    odf.ListStyleToCss = function () {
        ...
        function c(c,
            ...
            c = new a(c);
            var f, p, m, w, u, z, H = {}, C;
            for (C = 0; C < e.length; C += 1)if (f = e.item(C), z = f.getAttributeNS(h, "style-name")) {
                ...
                for (var D = void 0, I = {}; u;) {
                    var D = (D = u.getAttributeNS(h, "level")) && parseInt(D, 10), N = I, K = u, G = "", A = void 0, Y = void 0, T = A = void 0;
                    if ("list-level-style-number" === K.localName) {
                        var J = K, G = J.getAttributeNS(b, "num-format"),
                            A = J.getAttributeNS(b, "num-suffix") || "", Y = J.getAttributeNS(b, "num-prefix") || "", U = "", aa = J.getAttributeNS(h, "level"), J = J.getAttributeNS(h, "display-levels");
                        Y && (U += '"' + l(Y) + '"\n');
                        if (q.hasOwnProperty(G))for (aa = aa ? parseInt(aa, 10) : 1, J = J ? parseInt(J, 10) : 1; 0 < J;)U += " counter(" + (aa - J + 1) + "webodf-listLevel," + q[G] + ")", 1 < J && (U += '"."'), J -= 1; else U = G ? U + (' "' + G + '"') : U + ' ""';
                        G = "content:" + U + ' "' + l(A) + '"'
        ...
        var e = new core.CSSUnits, p = odf.OdfUtils;
...
odf.Style2CSS = function () {
    ...
    function a(a, b) {
        var c = "", e, d, g;
        for (e = 0; e < b.length; e += 1)if (d = b[e], g = a.getAttributeNS(d[0], d[1])) {
            g = g.trim();
            if (G.hasOwnProperty(d[1])) {
                var f = g, h = f.indexOf(" "), p = void 0;
                g = void 0;
                -1 !== h ? (p = f.substring(0, h), g = f.substring(h)) : (p = f, g = "");
                (p = T.parseLength(p)) && "pt" === p.unit && 0.75 > p.value && (f = "0.75pt" + g);
                g = f
            } else if (A.hasOwnProperty(d[1])) {
                var f =
                    a, h = d[0], p = d[1], l = T.parseLength(g), m = void 0, q = void 0, n = void 0, K = void 0, n = void 0;
                if (l && "%" === l.unit) {
                    m = l.value / 100;
                    q = k(f.parentNode);
                    for (K = "0"; q;) {
                        if (n = x.getDirectChild(q, r, "paragraph-properties"))if (n = T.parseLength(n.getAttributeNS(h, p))) {
                            if ("%" !== n.unit) {
                                K = n.value * m + n.unit;
                                break
                            }
    ...
    function n(b, c, G, A) {
        ...
        if ("page" ===
            c) {
            var F = A.element, U = "", R, P;
            P = R = "";
            G = x.getDirectChild(F, r, "page-layout-properties");
            var S;
            if (G)if (S = F.getAttributeNS(r, "name"), U += a(G, N), (R = x.getDirectChild(G, r, "background-image")) && (P = R.getAttributeNS(p, "href")) && (U = U + ("background-image: url('odfkit:" + P + "');") + a(R, w)), "presentation" === J)for (F = (F = x.getDirectChild(F.parentNode.parentNode, l, "master-styles")) && F.firstElementChild; F;)F.namespaceURI === r && "master-page" === F.localName && F.getAttributeNS(r, "page-layout-name") === S && (P = F.getAttributeNS(r, "name"),
                R = 'draw|page[draw|master-page-name="' + P + '"] {' + U + "}", P = 'office|body, draw|page[draw|master-page-name="' + P + '"] {' + a(G, K) + " }", b.insertRule(R, b.cssRules.length), b.insertRule(P, b.cssRules.length)), F = F.nextElementSibling; else"text" === J && (R = "office|text {" + U + "}", P = "office|body {width: " + G.getAttributeNS(m, "page-width") + ";}", b.insertRule(R, b.cssRules.length), b.insertRule(P, b.cssRules.length))
        } else {
            U = f(c, G, A).join(",");
            S = "";
    ...
    var q = odf.Namespaces.drawns, m = odf.Namespaces.fons, l = odf.Namespaces.officens, r = odf.Namespaces.stylens, c = odf.Namespaces.svgns, e = odf.Namespaces.tablens, p = odf.Namespaces.xlinkns, g = odf.Namespaces.presentationns, x = core.DomUtils, t = new odf.StyleParseUtils, y = {
            graphic: "draw",
            "drawing-page": "draw",
            paragraph: "text",
            presentation: "presentation",
            ...
            list: ["list-item"]
        }, s = [[m, "color", "color"], [m, "background-color", "background-color"], [m, "font-weight", "font-weight"], [m, "font-style", "font-style"]], w = [[r, "repeat", "background-repeat"]], u = [[m, "background-color", "background-color"], [m, "text-align", "text-align"], [m, "text-indent", "text-indent"], [m, "padding", "padding"], [m, "padding-left", "padding-left"], [m, "padding-right", "padding-right"], [m, "padding-top", "padding-top"], [m, "padding-bottom", "padding-bottom"], [m, "border-left", "border-left"], [m, "border-right",
            "border-right"], [m, "border-top", "border-top"], [m, "border-bottom", "border-bottom"], [m, "margin", "margin"], [m, "margin-left", "margin-left"], [m, "margin-right", "margin-right"], [m, "margin-top", "margin-top"], [m, "margin-bottom", "margin-bottom"], [m, "border", "border"]], z = [[m, "background-color", "background-color"], [m, "min-height", "min-height"], [q, "stroke", "border"], [c, "stroke-color", "border-color"], [c, "stroke-width", "border-width"], [m, "border", "border"], [m, "border-left", "border-left"], [m, "border-right", "border-right"],
            [m, "border-top", "border-top"], [m, "border-bottom", "border-bottom"]], H = [[m, "background-color", "background-color"], [m, "border-left", "border-left"], [m, "border-right", "border-right"], [m, "border-top", "border-top"], [m, "border-bottom", "border-bottom"], [m, "border", "border"]], C = [[r, "column-width", "width"]], D = [[r, "row-height", "height"], [m, "keep-together", null]], I = [[r, "width", "width"], [m, "margin-left", "margin-left"], [m, "margin-right", "margin-right"], [m, "margin-top", "margin-top"], [m, "margin-bottom", "margin-bottom"]],
        ...
        K = [[m, "page-width", "width"], [m, "page-height", "height"]], G = {
            border: !0,
            "border-left": !0,
            "border-right": !0,
            "border-top": !0,
            ...
            "margin-top": !0,
            "margin-bottom": !0
        }, Y = {}, T = odf.OdfUtils, J, U, aa, P = xmldom.XPath, E = new core.CSSUnits;
    this.style2css = function (a, b, c, e, d) {
        ...
        for (p in y)if (y.hasOwnProperty(p))for (h in a = d[p], a)a.hasOwnProperty(h) && n(c, p, h, a[h])
    }
};
(function () {
    function f(k, a) {
    ...
    gui.ZoomHelper = function () {
        ...
        function d(a) {
            if (s && C) {
                var b = s.style.overflow, c = s.classList.contains("webodf-customScrollbars");
        ...
        function m(a) {
            var c = a.touches.length, e = 0 < c ? n(a.touches[0]) : null;
        ...
        function l(c) {
            var d = c.touches.length,
                g = 0 < d ? n(c.touches[0]) : null, d = 1 < d ? n(c.touches[1]) : null;
            if (g && d)if (c.preventDefault(), H === z.SCROLL)H = z.PINCH, b(), x = g.getDistance(d); else {
                c = g.getCenter(d);
                g = g.getDistance(d) / x;
                q(c);
                var d = t, f = Math.min(v, e.offsetParent.clientWidth / e.offsetWidth);
                t = y * g;
        ...
        var e, p, g, x, t, y, v = 4, s, w, u = new core.EventNotifier([gui.ZoomHelper.signalZoomChanged]), z = {
            NONE: 0,
            SCROLL: 1,
            PINCH: 2
        }, H = z.NONE, C = runtime.getWindow().hasOwnProperty("ontouchstart"), D = "";
...
(function () {
    ...
    function b(a, b, c) {
        var e = new odf.Style2CSS, d = new odf.ListStyleToCss;
        c = c.sheet;
    ...
    function n(a, b, c) {
        ...
        var d;
        if (c && 0 < a.length)for (b = 0; b < a.length; b +=
            1)if (d = a[b], d.getAttributeNS(I, "name") === c) {
            e = d.textContent;
            break
        }
        return e
    ...
    function m(a, b, c) {
        ...
        var e, d = b.getAttributeNS(C, "anchor-type"), g = b.getAttributeNS(z, "x"), f = b.getAttributeNS(z, "y"), h = b.getAttributeNS(z, "width"), p = b.getAttributeNS(z, "height"), l = b.getAttributeNS(s, "min-height"), m = b.getAttributeNS(s,
            "min-width");
        if ("as-char" === d)e = "display: inline-block;"; else if (d || g || f)e = "position: absolute;"; else if (h || p || l || m)e = "display: block;";
        g && (e += "left: " + g + ";");
        f && (e += "top: " + f + ";");
        h && (e += "width: " + h + ";");
        p && (e += "height: " + p + ";");
    ...
    function r(a, b, c, e) {
        ...
        var f = c.getAttributeNS(D, "href"), h;
        if (f)try {
    ...
    function e(a) {
        ...
        K.getElementsByTagNameNS(a, C, "s").forEach(function (a) {
            ...
            if (1 < e)for (a.removeAttributeNS(C, "c"), c = 1; c < e; c += 1)a.parentNode.insertBefore(a.cloneNode(!0), a)
        })
    }
    ...
    function x(a) {
        var b = a.getElementsByTagName("head")[0], c, e;
    ...
    function y(a) {
        var b = a.getElementsByTagName("head")[0], c = a.createElementNS(b.namespaceURI,
            "style"), e = "";
    ...
    var v = odf.Namespaces.drawns, s = odf.Namespaces.fons, w = odf.Namespaces.officens, u = odf.Namespaces.stylens, z = odf.Namespaces.svgns, H = odf.Namespaces.tablens, C = odf.Namespaces.textns, D = odf.Namespaces.xlinkns,
        I = odf.Namespaces.presentationns, N = xmldom.XPath, K = core.DomUtils;
    odf.OdfCanvas = function (l, s) {
        ...
        function U(b, d) {
            ...
            var f = d.body, h, k = [], r;
            for (h = f.firstElementChild; h && h !== f;)if (h.namespaceURI === v && (k[k.length] = h), h.firstElementChild)h = h.firstElementChild; else {
            ...
            if ((k = d.body.firstElementChild) && k.namespaceURI === w && ("presentation" === k.localName || "drawing" === k.localName))for (k =
        ...
        var Q = this, $ = l.ownerDocument, B, V = new odf.Formatting, ba, Z = null, F = null, X = !1, R = !1, da = null, S, M, ea, ha, ca, fa = {}, pa, ka, ia = !1, la = !1, ma = new f, ga = new gui.ZoomHelper, ja = s || new gui.SingleScrollViewport(l.parentNode);
        ...
        this.fitToContainingElement = function (a, b) {
            var c = ga.getZoomLevel(), e = l.offsetHeight / c, c = a / (l.offsetWidth / c);
            b / e < c && (c = b / e);
            ga.setZoomLevel(c)
        };
        ...
        this.addCssForFrameWithImage = function (a) {
            var b = a.getAttributeNS(v, "name"), c = a.firstElementChild;
            m(b, a, ha.sheet);
            c && r(b + "img", B, c, ha.sheet)
        };
        this.destroy = function (a) {
            var b = $.getElementsByTagName("head")[0], c = [ba.destroy, ka.destroy];
...
odf.StepUtils = function () {
    this.getContentBounds = function (f) {
        ...
        k && (k.nodeType === Node.TEXT_NODE ? (runtime.assert(0 < a, "Empty text node found"), d = {container: k, startOffset: a - 1, endOffset: a}) : d = {
            container: k,
            startOffset: 0,
...
ops.OdtCursor = function (f, k) {
    var a = this, d = {}, b, h, n = new core.EventNotifier([ops.OdtCursor.signalCursorUpdated]);
...
(function () {
    ...
    ops.StepsCache = function (k, a, d) {
        ...
        var p =
            "urn:webodf:names:steps", g = {}, x = {}, t = core.DomUtils, y, v, s = Node.DOCUMENT_POSITION_FOLLOWING, w = Node.DOCUMENT_POSITION_PRECEDING, u;
        this.updateBookmark = function (e, d) {
            var f, h = Math.ceil(e / a) * a, p, n, q;
            if (void 0 !== v && v < e) {
                p = r(v);
            ...
            if (p !== n && p.nextBookmark !== n) {
                if (p.steps === n.steps)for (; 0 !== (n.node.compareDocumentPosition(p.node) & s) && p !== y;)p = p.previousBookmark;
        ...
        this.setToClosestDomPoint = function (a, b, c) {
            var d, f;
            u();
            if (a === k && 0 === b)d = y; else if (a === k && b === k.childNodes.length)for (f in d = y, g)g.hasOwnProperty(f) && (a = g[f], a.steps > d.steps && (d = a)); else if (d = e(a.childNodes.item(b) || a), !d)for (c.setUnfilteredPosition(a, b); !d && c.previousNode();)d = e(c.getCurrentNode());
            d = d || y;
...
(function () {
    ops.OdtStepsTranslator = function (f, k, a, d) {
        ...
        function q(b, c) {
            ...
            for (; b.previousPosition();)if (a.acceptPosition(b) === p) {
                if (c(g,
                        b.container(), b.unfilteredDomOffset()))return !0;
                break
            }
            for (; b.nextPosition();)if (a.acceptPosition(b) === p) {
        ...
        var m, l, r = odf.OdfUtils, c = core.DomUtils, e, p = core.PositionFilter.FilterResult.FILTER_ACCEPT, g = core.StepDirection.PREVIOUS, x = core.StepDirection.NEXT;
        this.convertStepsToDomPoint = function (c) {
            ...
            return {node: e.container(), offset: e.unfilteredDomOffset()}
        };
        this.convertDomPointToSteps = function (d, g, f) {
            ...
            for (; (e.container() !== f || e.unfilteredDomOffset() !== g) && e.nextPosition();)(h = a.acceptPosition(e) === p) && (d += 1), b(d, e, h);
            return d + 0
        };
        this.prime = function () {
            var c, d;
...
ops.TextPositionFilter = function () {
    ...
    var a = odf.OdfUtils, d = Node.ELEMENT_NODE, b = Node.TEXT_NODE, h = core.PositionFilter.FilterResult.FILTER_ACCEPT, n = core.PositionFilter.FilterResult.FILTER_REJECT;
    this.acceptPosition = function (f) {
        var m = f.container(), l = m.nodeType, r, c, e;
        if (l !== d && l !== b)return n;
        if (l === b) {
            ...
            if (0 < l) {
                ...
                if (1 < l)if (f = r[l - 2], !a.isODFWhitespace(f))e =
                    h; else {
...
ops.OdtDocument = function (f) {
    ...
    function l(a) {
        ...
        do {
            if (b = e.getContentBounds(a))if (b =
    ...
    var c = this, e, p = odf.OdfUtils, g = core.DomUtils, x = {}, t = {}, y = new core.EventNotifier([ops.Document.signalMemberAdded,
        ...
        ops.OdtDocument.signalUndoStackChanged, ops.OdtDocument.signalStepsInserted, ops.OdtDocument.signalStepsRemoved, ops.OdtDocument.signalMetadataUpdated, ops.OdtDocument.signalAnnotationAdded]), v = core.PositionFilter.FilterResult.FILTER_ACCEPT, s = core.PositionFilter.FilterResult.FILTER_REJECT, w = core.StepDirection.NEXT, u, z, H, C = NodeFilter.SHOW_ALL, D = new gui.BlacklistNamespaceNodeFilter(["urn:webodf:names:cursor", "urn:webodf:names:editinfo"]), I = new gui.OdfTextBodyNodeFilter, N = new core.NodeFilterChain([D, I]);
    this.createPositionIterator = k;
    this.getDocumentElement = function () {
        return f.odfContainer().rootElement
    };
    this.cloneDocumentElement = function () {
        var a = c.getDocumentElement(), b = f.getAnnotationViewManager();
    ...
    this.upgradeWhitespacesAtPosition = function (a) {
        var b = q(a), b = new core.StepIterator(u, b), c, d = 2;
        runtime.assert(b.isStep(), "positionIterator is not at a step (requested step: " + a + ")");
        do {
            if (c = e.getContentBounds(b))if (a = c.container, c = c.startOffset, a.nodeType === Node.TEXT_NODE && p.isSignificantWhitespace(a, c)) {
                runtime.assert(" " ===
                a.data[c], "upgradeWhitespaceToElement: textNode.data[offset] should be a literal space");
                var g = a.ownerDocument.createElementNS(odf.Namespaces.textns, "text:s"), f = a.parentNode, h = a;
    ...
    this.getTextNodeAtStep = function (a, b) {
        var e = q(a), g = e.container(), f, h = 0, p = null;
    ...
    this.fixCursorPositions = function () {
        Object.keys(x).forEach(function (a) {
            var e = x[a], d = b(e.getNode()), g = c.createRootFilter(d), f, h, p, l = !1;
    ...
    this.addCursor = function (a) {
        ...
        var b = a.getMemberId(), e = c.convertCursorToDomRange(0, 0);
    ...
    y.subscribe(ops.OdtDocument.signalOperationEnd, function (a) {
        var b = a.spec(), e = b.memberid, d = (new Date(b.timestamp)).toISOString(), b = f.odfContainer();
        a.isEdit && (e = c.getMember(e).getProperties().fullName, b.setMetadata({
            "dc:creator": e,
            "dc:date": d
        }, null), e = {
            setProperties: {"dc:creator": e, "dc:date": d},
            removedProperties: []
...
ops.OpAddAnnotation = function () {
    ...
    this.execute = function (q) {
        var m = q.getCursor(k), l, r;
        n = q.getDOMDocument();
        var c = new Date(a), e, p, g;
        ...
        f(q, e, d);
        q.emit(ops.OdtDocument.signalStepsInserted, {position: d});
        ...
        q.emit(ops.OdtDocument.signalAnnotationAdded, {memberId: k, annotation: e});
        return !0
    };
    this.spec = function () {
        return {optype: "AddAnnotation", memberid: k, timestamp: a, position: d, length: b, name: h}
    }
};
...
ops.OpAddMember = function () {
    ...
    this.spec = function () {
        return {optype: "AddMember", memberid: f, timestamp: k, setProperties: a}
    }
};
ops.OpAddStyle = function () {
    ...
    this.execute = function (f) {
        var m = f.getOdfCanvas().odfContainer(), l = f.getFormatting(), k = f.getDOMDocument().createElementNS(n, "style:style");
        if (!k)return !1;
        h && l.updateStyle(k, h);
        ...
        b || f.emit(ops.OdtDocument.signalCommonStyleCreated, {name: a, family: d});
        return !0
    };
    this.spec = function () {
        return {optype: "AddStyle", memberid: f, timestamp: k, styleName: a, styleFamily: d, isAutomaticStyle: b, setProperties: h}
    }
};
odf.ObjectNameGenerator = function (f, k) {
    ...
    var b = odf.Namespaces.stylens, h = odf.Namespaces.drawns, n = odf.Namespaces.xlinkns, q = (new core.Utils).hashString(k),
        m = null, l = null, r = null, c = {}, e = {};
...
odf.TextStyleApplicator = function (f, k, a) {
    ...
    function h(a, b) {
        var c = a.ownerDocument, e = a.parentNode, d, g, f, h = new core.LoopWatchDog(1E4);
        g = [];
        g.push(a);
        ...
        if (f && c)for (g = d.cloneNode(!1), d.parentNode.insertBefore(g, d.nextSibling); f;)h.check(), c = f.nextSibling, g.appendChild(f), f = c;
        return d
    }

    var n = core.DomUtils, q = odf.Namespaces.textns, m = odf.Namespaces.stylens;
    this.applyStyle =
        function (a, f, c) {
            var e = {}, p, g, n, m;
...
ops.OpApplyDirectStyling = function () {
    function f(a, b, d) {
        var c = a.getOdfCanvas().odfContainer(), e = q.splitBoundaries(b), f = n.getTextNodes(b, !1);
    ...
    var k, a, d, b, h, n = odf.OdfUtils, q = core.DomUtils;
    this.init = function (f) {
        k = f.memberid;
        a = f.timestamp;
        d = parseInt(f.position, 10);
    ...
    this.execute =
        function (m) {
            var l = m.convertCursorToDomRange(d, b), q = n.getParagraphElements(l);
            f(m, l, h);
            l.detach();
            m.getOdfCanvas().refreshCSS();
            m.fixCursorPositions();
            q.forEach(function (b) {
                m.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: b, memberId: k, timeStamp: a})
            });
            m.getOdfCanvas().rerenderAnnotations();
            return !0
        };
    this.spec = function () {
        return {optype: "ApplyDirectStyling", memberid: k, timestamp: a, position: d, length: b, setProperties: h}
    }
};
ops.OpApplyHyperlink = function () {
    ...
    var k, a, d, b, h, n = core.DomUtils, q = odf.OdfUtils;
    this.init = function (f) {
        k = f.memberid;
        a = f.timestamp;
        d = f.position;
    ...
    this.execute = function (m) {
        var l = m.getDOMDocument(), r = m.convertCursorToDomRange(d, b), c = n.splitBoundaries(r), e = [], p = q.getTextNodes(r, !1);
        if (0 === p.length)return !1;
        p.forEach(function (a) {
            var b = q.getParagraphElement(a);
            runtime.assert(!1 ===
            f(a), "The given range should not contain any link.");
            var c = h, d = l.createElementNS(odf.Namespaces.textns, "text:a");
        ...
        e.forEach(function (b) {
            m.emit(ops.OdtDocument.signalParagraphChanged,
                {paragraphElement: b, memberId: k, timeStamp: a})
        });
        return !0
    };
    this.spec = function () {
        return {optype: "ApplyHyperlink", memberid: k, timestamp: a, position: d, length: b, hyperlink: h}
    }
};
ops.OpInsertImage = function () {
    var f, k, a, d, b, h, n, q, m = odf.Namespaces.drawns, l = odf.Namespaces.svgns, r = odf.Namespaces.textns, c = odf.Namespaces.xlinkns, e = odf.OdfUtils;
    ...
    this.execute = function (p) {
        var g = p.getOdfCanvas(), x = p.getTextNodeAtStep(a, f), t, y;
        if (!x)return !1;
        t = x.textNode;
        y = e.getParagraphElement(t);
        var x = x.offset !== t.length ? t.splitText(x.offset) :
            t.nextSibling, v = p.getDOMDocument(), s = v.createElementNS(m, "draw:image"), v = v.createElementNS(m, "draw:frame");
        ...
        t.parentNode.insertBefore(v,
            x);
        p.emit(ops.OdtDocument.signalStepsInserted, {position: a});
        0 === t.length && t.parentNode.removeChild(t);
        g.addCssForFrameWithImage(v);
        g.refreshCSS();
        p.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: y, memberId: f, timeStamp: k});
        g.rerenderAnnotations();
        return !0
    };
    this.spec = function () {
        return {optype: "InsertImage", memberid: f, timestamp: k, filename: d, position: a, frameWidth: b, frameHeight: h, frameStyleName: n, frameName: q}
    }
};
ops.OpInsertTable = function () {
    function f(a, e) {
        var f;
        if (1 === l.length)f = l[0]; else if (3 === l.length)switch (a) {
            case 0:
                f = l[0];
                break;
            case d - 1:
    ...
    this.execute = function (c) {
        var e = c.getTextNodeAtStep(h), p = c.getRootNode();
        if (e) {
            var g = c.getDOMDocument(), l = g.createElementNS("urn:oasis:names:tc:opendocument:xmlns:table:1.0", "table:table"), t = g.createElementNS("urn:oasis:names:tc:opendocument:xmlns:table:1.0", "table:table-column"), y, v, s, w;
            ...
            c.emit(ops.OdtDocument.signalStepsInserted, {position: h});
            c.getOdfCanvas().refreshSize();
            c.emit(ops.OdtDocument.signalTableAdded, {tableElement: l, memberId: k, timeStamp: a});
    ...
    this.spec = function () {
        return {
            optype: "InsertTable", memberid: k, timestamp: a, position: h, initialRows: d, initialColumns: b, tableName: n, tableStyleName: q, tableColumnStyleName: m,
...
ops.OpInsertText = function () {
    ...
    this.execute = function (n) {
        var q, m, l, r = null, c = n.getDOMDocument(), e, p = 0, g, x = n.getCursor(f), t;
        ...
        if (q = n.getTextNodeAtStep(a)) {
            ...
            for (t = 0; t < b.length; t += 1)if ("\t" === b[t] || "\t" !== b[t] && h.isODFWhitespace(b[t]) &&
            ...
            n.emit(ops.OdtDocument.signalStepsInserted, {position: a});
            ...
            n.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: e, memberId: f, timeStamp: k});
    ...
    this.spec = function () {
        return {optype: "InsertText", memberid: f, timestamp: k, position: a, text: b, moveCursor: d}
    }
};
odf.CollapsingRules = function (f) {
    ...
    var d = odf.OdfUtils, b = core.DomUtils;
...
ops.OpMergeParagraph = function () {
    ...
    var b, h, n, q, m, l, r = odf.OdfUtils, c = core.DomUtils, e = odf.Namespaces.textns;
    this.init = function (a) {
        b = a.memberid;
        h = a.timestamp;
        n = a.moveCursor;
    ...
    this.execute = function (p) {
        ...
        g = p.getRootNode();
        var y = new odf.CollapsingRules(g), v = p.createStepIterator(g, 0, [p.getPositionFilter()], g), s;
        ...
        p.emit(ops.OdtDocument.signalStepsRemoved, {position: m - 1});
        v.setPosition(k, s);
        ...
        p.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: k, memberId: b, timeStamp: h});
        p.getOdfCanvas().rerenderAnnotations();
        return !0
    };
    this.spec = function () {
        return {optype: "MergeParagraph", memberid: b, timestamp: h, moveCursor: n, paragraphStyleName: q, sourceStartPosition: m, destinationStartPosition: l}
    }
};
ops.OpMoveCursor = function () {
    ...
    this.spec = function () {
        return {optype: "MoveCursor", memberid: f, timestamp: k, position: a, length: d, selectionType: b}
    }
};
ops.OpRemoveAnnotation = function () {
    ...
    this.execute = function (d) {
        ...
        d.emit(ops.OdtDocument.signalStepsRemoved, {position: 0 < a ? a - 1 : a});
        d.fixCursorPositions();
        d.getOdfCanvas().refreshAnnotations();
        return !0
    };
    this.spec = function () {
        return {optype: "RemoveAnnotation", memberid: f, timestamp: k, position: a, length: d}
    }
};
ops.OpRemoveBlob = function () {
    ...
    this.spec = function () {
        return {optype: "RemoveBlob", memberid: f, timestamp: k, filename: a}
    }
};
...
ops.OpRemoveHyperlink = function () {
    var f, k, a, d, b = core.DomUtils, h = odf.OdfUtils;
    this.init = function (b) {
        f = b.memberid;
        k = b.timestamp;
        a = b.position;
    ...
    this.group = void 0;
    this.execute = function (n) {
        var q = n.convertCursorToDomRange(a, d), m = h.getHyperlinkElements(q);
        ...
        n.emit(ops.OdtDocument.signalParagraphChanged,
            {paragraphElement: h.getParagraphElement(m), memberId: f, timeStamp: k});
        return !0
    };
    this.spec = function () {
        return {optype: "RemoveHyperlink", memberid: f, timestamp: k, position: a, length: d}
    }
};
...
ops.OpRemoveStyle = function () {
    ...
    this.execute = function (b) {
        ...
        b.emit(ops.OdtDocument.signalCommonStyleDeleted, {name: a, family: d});
        return !0
    };
    this.spec = function () {
        return {optype: "RemoveStyle", memberid: f, timestamp: k, styleName: a, styleFamily: d}
    }
};
ops.OpRemoveText = function () {
    var f, k, a, d, b = odf.OdfUtils, h = core.DomUtils;
    this.init = function (b) {
    ...
    this.group = void 0;
    this.execute = function (n) {
        var q, m, l, r = n.getCursor(f), c = new odf.CollapsingRules(n.getRootNode());
        n.upgradeWhitespacesAtPosition(a);
        ...
        n.emit(ops.OdtDocument.signalStepsRemoved, {position: a});
        n.downgradeWhitespacesAtPosition(a);
        n.fixCursorPositions();
        n.getOdfCanvas().refreshSize();
        n.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: l, memberId: f, timeStamp: k});
        r && (r.resetSelectionType(), n.emit(ops.Document.signalCursorMoved, r));
        n.getOdfCanvas().rerenderAnnotations();
        return !0
    };
    this.spec = function () {
        return {optype: "RemoveText", memberid: f, timestamp: k, position: a, length: d}
    }
};
ops.OpSetBlob = function () {
    ...
    this.spec = function () {
        return {optype: "SetBlob", memberid: f, timestamp: k, filename: a, mimetype: d, content: b}
    }
};
ops.OpSetParagraphStyle = function () {
    function f(a, b, d) {
        var f = [a.getPositionFilter()], h = d.container();
    ...
    this.spec = function () {
        return {optype: "SetParagraphStyle", memberid: k, timestamp: a, position: d, styleName: b}
    }
};
ops.OpSplitParagraph = function () {
    var f, k, a, d, b, h, n = odf.OdfUtils, q = odf.Namespaces.textns;
    this.init = function (n) {
        f = n.memberid;
        k = n.timestamp;
        d = n.position;
    ...
    this.execute = function (a) {
        ...
        for (e = l.textNode; e !== c;) {
            ...
            p = e.cloneNode(!1);
            g && p.appendChild(g);
            if (x)for (; x && x.nextSibling;)p.appendChild(x.nextSibling); else for (; e.firstChild;)p.appendChild(e.firstChild);
        ...
        a.emit(ops.OdtDocument.signalStepsInserted, {position: d});
        t && b && (a.moveCursor(f, d + 1, 0), a.emit(ops.Document.signalCursorMoved, t));
        a.fixCursorPositions();
        a.getOdfCanvas().refreshSize();
        a.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: r, memberId: f, timeStamp: k});
        a.emit(ops.OdtDocument.signalParagraphChanged, {paragraphElement: g, memberId: f, timeStamp: k});
    ...
    this.spec = function () {
        return {
            ...
            memberid: f, timestamp: k, position: d, sourceParagraphPosition: a, paragraphStyleName: h, moveCursor: b
        }
    }
};
ops.OpUpdateMember = function () {
    ...
    this.spec = function () {
        return {optype: "UpdateMember", memberid: k, timestamp: a, setProperties: d, removedProperties: b}
    }
};
ops.OpUpdateMetadata = function () {
    ...
    this.group = void 0;
    this.execute = function (b) {
        var f = b.getOdfCanvas().odfContainer(), n = null;
        d && (n = d.attributes.split(","));
        f.setMetadata(a, n);
        b.emit(ops.OdtDocument.signalMetadataUpdated, {setProperties: null !== a ? a : {}, removedProperties: null !== n ? n : []});
        return !0
    };
    this.spec = function () {
        return {
            optype: "UpdateMetadata", memberid: f, timestamp: k, setProperties: a,
            removedProperties: d
        }
    }
};
ops.OpUpdateParagraphStyle = function () {
    ...
    this.spec =
        function () {
            return {optype: "UpdateParagraphStyle", memberid: k, timestamp: a, styleName: d, setProperties: b, removedProperties: h}
        }
};
...
ops.TrivialOperationRouter = function () {
    var f = new core.EventNotifier([ops.OperationRouter.signalProcessingBatchStart, ops.OperationRouter.signalProcessingBatchEnd]), k, a, d = 0;
...
ops.Session = function (f) {
    ...
    var d = new ops.OperationFactory, b = new ops.OdtDocument(f), h = null;
    this.setOperationFactory = function (a) {
        d = a;
...
gui.AnnotationController = function (f, k, a) {
    function d() {
        var b = q.getCursor(a), b = b && b.getNode(), c = !1;
    ...
    var q = f.getOdtDocument(), m = !1, l = new core.EventNotifier([gui.AnnotationController.annotatableChanged]), r = odf.OdfUtils, c = core.StepDirection.NEXT;
    this.isAnnotatable = function () {
        return m
    };
    this.addAnnotation =
        function () {
            var b = new ops.OpAddAnnotation, c = q.getCursorSelection(a), d = c.length, c = c.position;
            m && (c = 0 <= d ? c : c + d, d = Math.abs(d), b.init({memberid: a, position: c, length: d, name: a + Date.now()}), f.enqueue([b]))
        };
    this.removeAnnotation = function (b) {
        ...
        if (!0 !== k.getState(gui.CommonConstraints.EDIT.ANNOTATIONS.ONLY_DELETE_OWN) || d === r.getAnnotationCreator(b))d = q.convertDomPointToCursorStep(b, 0, c), g = q.convertDomPointToCursorStep(b, b.childNodes.length), b = new ops.OpRemoveAnnotation,
            b.init({memberid: a, position: d, length: g - d}), g = new ops.OpMoveCursor, g.init({memberid: a, position: 0 < d ? d - 1 : d, length: 0}), f.enqueue([b, g])
    };
    this.subscribe = function (a, b) {
        l.subscribe(a, b)
    };
...
gui.GuiStepUtils = function () {
    function f(b) {
        ...
        var f, h = null;
        if (b)if (b.container.nodeType === Node.TEXT_NODE)f = b.container.ownerDocument.createRange(), f.setStart(b.container, b.startOffset), f.setEnd(b.container, b.endOffset), (h = 0 < f.getClientRects().length ? f.getBoundingClientRect() : null) && " " === b.container.data.substring(b.startOffset, b.endOffset) && 1 >= h.width && (h = null), f.detach(); else if (k.isCharacterElement(b.container) || k.isCharacterFrame(b.container))h = d.getBoundingClientRect(b.container);
        return h
    }

    var k = odf.OdfUtils, a = new odf.StepUtils, d = core.DomUtils, b = core.StepDirection.NEXT, h = gui.StepInfo.VisualDirection.LEFT_TO_RIGHT, n = gui.StepInfo.VisualDirection.RIGHT_TO_LEFT;
    ...
    this.moveToFilteredStep = function (a, d, l) {
        ...
        var c = d === b, e, p, g, x, t, y = a.snapshot();
        e = !1;
        var v;
        do e = f(a), v = {
            token: a.snapshot(),
...
gui.Caret = function (f, k, a, d) {
    ...
    function q() {
        if (!1 === C.isShown || f.getSelectionType() !== ops.OdtCursor.RangeSelection || !d && !f.getSelectedRange().collapsed)C.visibility = "hidden", r.style.visibility = "hidden", w.cancel(); else if (C.visibility = "visible", r.style.visibility = "visible", !1 === C.isFocused)r.style.opacity =
            "1", w.cancel(); else {
        ...
        if (H || z) {
            var a;
            a = f.getNode();
            var b, g, p = t.getBoundingClientRect(x.getSizer()), m = !1, q = 0;
            a.removeAttributeNS("urn:webodf:names:cursor", "caret-sizer-active");
            if (0 < a.getClientRects().length)g = h(), q = g.left - t.getBoundingClientRect(a).left, m = !0; else if (v.setPosition(a, 0), g = y.getContentRect(v), !g && v.nextStep() && (b = y.getContentRect(v)) && (g = b, m = !0), g || (a.setAttributeNS("urn:webodf:names:cursor", "caret-sizer-active",
                    "true"), g = h(), m = !0), !g)for (runtime.log("WARN: No suitable client rectangle found for visual caret for " + f.getMemberId()); a;) {
            ...
            a = {top: g.top, height: g.height, right: m ? g.left : g.right, width: t.adaptRangeDifferenceToZoomLevel(q, x.getZoomLevel())};
    ...
    var l, r, c, e, p, g, x = f.getDocument().getCanvas(), t = core.DomUtils, y = new gui.GuiStepUtils, v, s, w, u = !1, z = !1, H = !1, C = {
        isFocused: !1,
        isShown: !0,
        visibility: "hidden"
    }, D = {isFocused: !C.isFocused, isShown: !C.isShown, visibility: "hidden"};
    ...
    (function () {
        var e = f.getDocument(), d = [e.createRootFilter(f.getMemberId()), e.getPositionFilter()], h = e.getDOMDocument();
        g = h.createRange();
...
odf.TextSerializer = function () {
    function f(d) {
        var b = "", h = k.filter ? k.filter.acceptNode(d) : NodeFilter.FILTER_ACCEPT, n = d.nodeType, q;
        if ((h === NodeFilter.FILTER_ACCEPT || h === NodeFilter.FILTER_SKIP) && a.isTextContentContainingNode(d))for (q = d.firstChild; q;)b += f(q), q = q.nextSibling;
        h === NodeFilter.FILTER_ACCEPT && (n === Node.ELEMENT_NODE && a.isParagraph(d) ? b += "\n" : n === Node.TEXT_NODE && d.textContent && (b += d.textContent));
        return b
    }

    var k = this, a = odf.OdfUtils;
    this.filter = null;
...
gui.SessionContext = function (f, k) {
    var a = f.getOdtDocument(), d = odf.OdfUtils;
    this.isLocalCursorWithinOwnAnnotation = function () {
        var b = a.getCursor(k), f;
        if (!b)return !1;
        f = b && b.getNode();
...
gui.StyleSummary = function (f) {
    function k(a, d) {
        ...
        b.hasOwnProperty(k) || (m = [], f.forEach(function (b) {
            b = (b = b.styleProperties[a]) && b[d];
            -1 === m.indexOf(b) && m.push(b)
        }), b[k] = m);
        return b[k]
    }
...
gui.DirectFormattingController = function (f, k, a, d, b, h, n) {
    ...
    function r() {
        var b = J.getCursor(d), c = b && b.getSelectedRange(), e = [], e = [], g = !0, f = {directTextStyling: !0, directParagraphStyling: !0};
        c && (e = l(c), 0 === e.length && (e = [c.startContainer,
            c.endContainer], g = !1), e = J.getFormatting().getAppliedStyles(e));
        ...
        return {enabledFeatures: f, appliedStyles: e, styleSummary: new gui.StyleSummary(e)}
    }
    ...
    function e() {
        var a, b;
        b = B.styleSummary;
        var e = V.value(), d = e.styleSummary, g = B.enabledFeatures, f = e.enabledFeatures;
        a = c(b.text, d.text);
    ...
    function v(a) {
        if (m().directTextStyling) {
            var b = J.getCursorSelection(d), c = {"style:text-properties": a};
            0 !== b.length ? (a = new ops.OpApplyDirectStyling, a.init({memberid: d, position: b.position, length: b.length, setProperties: c}), f.enqueue([a])) : ($ =
    ...
    function D(a) {
        if (m().directParagraphStyling) {
            var c = J.getCursor(d).getSelectedRange(), c = aa.getParagraphElements(c),
                e = J.getFormatting(), g = [], h = {}, l;
            c.forEach(function (c) {
                var f = J.convertDomPointToCursorStep(c, 0, Q), p = c.getAttributeNS(odf.Namespaces.textns, "style-name"), k;
                ...
                p.init({
                    memberid: d, styleName: c.toString(),
                    position: f
                });
                g.push(p)
            });
    ...
    function N(a) {
        I({"style:paragraph-properties": {"fo:text-align": a}})
    }

    function K(a, b) {
        var c = J.getFormatting().getDefaultTabStopDistance(), e = b["style:paragraph-properties"], d;
        e && (e = e["fo:margin-left"], d = aa.parseLength(e));
        return U.mergeObjects(b, {"style:paragraph-properties": {"fo:margin-left": d && d.unit === c.unit ? d.value + a * c.value + d.unit : a * c.value + c.unit}})
    }

    function G(a, b) {
        var c = l(a), c = 0 === c.length ? [a.startContainer] :
            c, c = J.getFormatting().getAppliedStyles(c), e = 0 < c.length ? c[0].styleProperties : void 0, d = J.getFormatting().getAppliedStylesForElement(b).styleProperties;
    ...
    var T = this, J = f.getOdtDocument(), U = new core.Utils, aa = odf.OdfUtils, P = new core.EventNotifier([gui.DirectFormattingController.enabledChanged,
        gui.DirectFormattingController.textStylingChanged, gui.DirectFormattingController.paragraphStylingChanged]), E = odf.Namespaces.textns, Q = core.StepDirection.NEXT, $ = null, B, V;
    ...
    this.createCursorStyleOp = function (a, b, c) {
        ...
        g && g["style:text-properties"] && (e = new ops.OpApplyDirectStyling, e.init({
            ...
            position: a,
            length: b,
            setProperties: {"style:text-properties": g["style:text-properties"]}
        }),
            $ = null, V.reset());
        return e
    };
    ...
    this.createParagraphStyleOps = function (a) {
        ...
        var c = J.getCursor(d), e = c.getSelectedRange(), g = [], f, h;
        ...
        var l = c, p = [J.getPositionFilter(), J.createRootFilter(d)];
        ...
        if (!e)return g;
        if (c = c.getAttributeNS(E, "style-name"))e = {"style:text-properties": e["style:text-properties"]}, e = J.getFormatting().createDerivedStyleObject(c, "paragraph", e);
        f = b.generateStyleName();
        c = new ops.OpAddStyle;
        c.init({memberid: d, styleName: f, styleFamily: "paragraph", isAutomaticStyle: !0, setProperties: e});
        g.push(c);
        c = new ops.OpSetParagraphStyle;
        c.init({memberid: d, styleName: f, position: a});
        g.push(c);
        return g
    };
    this.subscribe = function (a, b) {
...
gui.KeyboardHandler = function () {
    ...
    var k = gui.KeyboardHandler.Modifier, a = null, d = {};
...
gui.HyperlinkClickHandler = function (f, k, a) {
    ...
    function n(e) {
        ...
        if (e !== q.None) {
            ...
            switch (e) {
                case q.Ctrl:
                    p.push({keyCode: m.Ctrl, modifier: q.None});
                    break;
                case q.Meta:
                    p.push({keyCode: m.LeftMeta, modifier: q.None}), p.push({keyCode: m.RightMeta, modifier: q.None}), p.push({
    ...
    var q = gui.KeyboardHandler.Modifier, m = gui.KeyboardHandler.KeyCode, l = xmldom.XPath, r = odf.OdfUtils, c = runtime.getWindow(), e = q.None, p = [];
    runtime.assert(null !==
    c, "Expected to be run in an environment which has a global window, like a browser.");
    this.handleClick = function (a) {
        var b = a.target || a.srcElement, d, h;
...
gui.EventManager = function (f) {
    function k(a) {
        ...
        var d = this, g = [], f = new core.EventNotifier([a]);
        this.filters = [];
    ...
    function a(a, b, c) {
        ...
        var d = {}, g = new core.EventNotifier([a]);
        this.subscribe = function (b) {
            g.subscribe(a, b)
        };
        this.unsubscribe =
    ...
    function h(a, c, e) {
        var g = a.touches.length, f = a.touches[0], h = c.timer;
        "touchmove" === a.type || "touchend" === a.type ? h && d(h) : "touchstart" === a.type && (1 !== g ? runtime.clearTimeout(h) : h = b(function () {
            e({
                ...
                pageX: f.pageX, pageY: f.pageY, target: a.target || a.srcElement || null, detail: 1
            })
        }, 400));
        c.timer = h
    }
    ...
    function n(a, b, c) {
        var e = a.touches[0], d = a.target || a.srcElement || null, g = b.target;
    ...
    var s = runtime.getWindow(), w = {beforecut: !0, beforepaste: !0, longpress: !0, drag: !0, dragstop: !0}, u = {
        mousedown: !0,
        mouseup: !0,
        focus: !0
    }, z = {}, H = {}, C, D = f.getCanvas().getElement(), I = this, N = {};
    this.addFilter = function (a, b) {
        c(a, !0).filters.push(b)
    };
    this.removeFilter = function (a, b) {
        var e = c(a, !0), d = e.filters.indexOf(b);
        -1 !== d && e.filters.splice(d, 1)
    };
    this.subscribe = e;
    this.unsubscribe = p;
    this.hasFocus = g;
    ...
    (function () {
        var b = f.getOdfCanvas().getSizer(), c = b.ownerDocument;
...
gui.IOSSafariSupport = function (f) {
    ...
    var a = runtime.getWindow(), d = f.getEventTrap();
    this.destroy = function (a) {
...
gui.HyperlinkController = function (f, k, a, d) {
    ...
    var n = odf.OdfUtils, q = f.getOdtDocument(), m = new core.EventNotifier([gui.HyperlinkController.enabledChanged]), l = !1;
    ...
    this.addHyperlink = function (a, b) {
        if (l) {
            var e = q.getCursorSelection(d), h = new ops.OpApplyHyperlink, g = [];
            if (0 === e.length || b)b = b || a, h = new ops.OpInsertText, h.init({memberid: d, position: e.position, text: b}), e.length = b.length, g.push(h);
            h = new ops.OpApplyHyperlink;
            h.init({memberid: d, position: e.position, length: e.length, hyperlink: a});
            g.push(h);
            f.enqueue(g)
        }
    };
    this.removeHyperlinks = function () {
        if (l) {
            var a = q.createPositionIterator(q.getRootNode()), b = q.getCursor(d).getSelectedRange(), e = n.getHyperlinkElements(b),
                h = b.collapsed && 1 === e.length, g = q.getDOMDocument().createRange(), k = [], m, y;
            0 !== e.length && (e.forEach(function (a) {
                g.selectNodeContents(a);
                m = q.convertDomToCursorRange({anchorNode: g.startContainer, anchorOffset: g.startOffset, focusNode: g.endContainer, focusOffset: g.endOffset});
                y = new ops.OpRemoveHyperlink;
                y.init({memberid: d, position: m.position, length: m.length});
                k.push(y)
...
gui.ImageController = function (f, k, a, d, b) {
    ...
    var q = {
        ...
        "image/jpeg": ".jpg",
        "image/png": ".png"
    }, m = odf.Namespaces.textns, l = f.getOdtDocument(), r = odf.OdfUtils, c = l.getFormatting(), e = new core.EventNotifier([gui.HyperlinkController.enabledChanged]), p = !1;
    this.isEnabled = function () {
        return p
    };
    this.subscribe = function (a, b) {
    ...
    this.insertImage = function (a, e, h, k) {
        if (p) {
            ...
            if (h = r.getParagraphElement(l.getCursor(d).getNode()).getAttributeNS(m, "style-name")) {
                ...
                h = Math.min(n, s);
                k = {
                    width: k.width * h, height: k.height *
                    h
                }
            }
            h = k.width + "px";
            k = k.height + "px";
            var w = l.getOdfCanvas().odfContainer().rootElement.styles, n = a.toLowerCase(), s = q.hasOwnProperty(n) ? q[n] : null, u, n = [];
            runtime.assert(null !== s, "Image type is not supported: " + a);
            s = "Pictures/" + b.generateImageName() + s;
            u = new ops.OpSetBlob;
            u.init({memberid: d, filename: s, mimetype: a, content: e});
            n.push(u);
            c.getStyleElement("Graphics", "graphic", [w]) || (a = new ops.OpAddStyle, a.init({
                memberid: d, styleName: "Graphics", styleFamily: "graphic", isAutomaticStyle: !1, setProperties: {
            ...
            e.init({
                memberid: d, styleName: a, styleFamily: "graphic", isAutomaticStyle: !0, setProperties: {
            ...
            u.init({
                memberid: d, position: l.getCursorPosition(d),
                filename: s, frameWidth: h, frameHeight: k, frameStyleName: a, frameName: b.generateFrameName()
            });
            n.push(u);
            f.enqueue(n)
        }
...
gui.ImageSelector = function (f) {
    function k() {
        var a = f.getSizer(), h = b.createElement("div");
        h.id = "imageSelector";
    ...
    var a = odf.Namespaces.svgns, d = "topLeft topRight bottomRight bottomLeft topMiddle rightMiddle bottomMiddle leftMiddle".split(" "), b = f.getElement().ownerDocument, h = !1;
    this.select = function (d) {
        ...
        var r = q.getBoundingClientRect(), c = f.getZoomLevel();
        q = (m.left - r.left) / c - 1;
        m = (m.top - r.top) / c - 1;
...
(function () {
    ...
    gui.InputMethodEditor = function (k, a) {
        ...
        function b() {
            y && (y = !1, d(!1), s.emit(gui.InputMethodEditor.signalCompositionEnd, {data: v}), v = "")
        }
        ...
        function q() {
            ...
            t.cancel();
            d(!0);
            y || s.emit(gui.InputMethodEditor.signalCompositionStart, {data: ""})
        }
        ...
        var c = "urn:webodf:names:cursor", e = null, p = a.getEventTrap(), g = p.ownerDocument, x, t, y = !1, v = "", s = new core.EventNotifier([gui.InputMethodEditor.signalCompositionStart, gui.InputMethodEditor.signalCompositionEnd]), w, u, z = [], H, C = !1;
...
gui.MetadataController = function (f, k) {
    ...
    var b = f.getOdtDocument(), h = new core.EventNotifier([gui.MetadataController.signalMetadataChanged]), n = ["dc:creator", "dc:date", "meta:editing-cycles", "meta:editing-duration", "meta:document-statistic"];
    this.setMetadata = function (a, b) {
        ...
        if (0 < n.length || 0 < Object.keys(h).length)c = new ops.OpUpdateMetadata, c.init({
            memberid: k,
            setProperties: h,
            removedProperties: 0 < n.length ? {attributes: n} : null
        }), f.enqueue([c])
    };
...
gui.PasteController = function (f, k, a, d) {
    ...
    var n = f.getOdtDocument(), q = !1, m = odf.Namespaces.textns, l = core.StepDirection.NEXT, r = odf.OdfUtils;
    this.isEnabled = function () {
        return q
    };
    this.paste = function (a) {
        if (q) {
            var b = n.getCursorPosition(d), h = n.getCursor(d).getNode(), h = r.getParagraphElement(h), g = h.getAttributeNS(m, "style-name") || "", k = b, t = [], y = n.convertDomPointToCursorStep(h,
                0, l);
            a.replace(/\r/g, "").split("\n").forEach(function (a) {
                var b = new ops.OpInsertText, c = new ops.OpSplitParagraph;
                b.init({memberid: d, position: k, text: a, moveCursor: !0});
                t.push(b);
                k += a.length;
                c.init({memberid: d, position: k, paragraphStyleName: g, sourceParagraphPosition: y, moveCursor: !0});
                t.push(c);
                y = k += 1
            });
            t.pop();
...
gui.ClosestXOffsetScanner = function (f) {
    ...
    var d = this, b, h = gui.StepInfo.VisualDirection.LEFT_TO_RIGHT;
    this.token = void 0;
...
gui.LineBoundaryScanner = function () {
    ...
    this.process = function (a, d, b) {
        ...
        if (h = b)if (k) {
            ...
            var q = Math.max(n.top, b.top), n = Math.min(n.bottom, b.bottom) - q;
            h = 0.4 >= (0 < h ? n / h : 0)
        } else h = !1;
...
gui.ParagraphBoundaryScanner = function () {
    var f = this, k = !1, a, d = odf.OdfUtils;
    this.token = void 0;
...
odf.WordBoundaryFilter = function (f, k) {
    ...
    var b = Node.TEXT_NODE, h = Node.ELEMENT_NODE,
        n = odf.OdfUtils, q = /[!-#%-*,-\/:-;?-@\[-\]_{}\u00a1\u00ab\u00b7\u00bb\u00bf;\u00b7\u055a-\u055f\u0589-\u058a\u05be\u05c0\u05c3\u05c6\u05f3-\u05f4\u0609-\u060a\u060c-\u060d\u061b\u061e-\u061f\u066a-\u066d\u06d4\u0700-\u070d\u07f7-\u07f9\u0964-\u0965\u0970\u0df4\u0e4f\u0e5a-\u0e5b\u0f04-\u0f12\u0f3a-\u0f3d\u0f85\u0fd0-\u0fd4\u104a-\u104f\u10fb\u1361-\u1368\u166d-\u166e\u169b-\u169c\u16eb-\u16ed\u1735-\u1736\u17d4-\u17d6\u17d8-\u17da\u1800-\u180a\u1944-\u1945\u19de-\u19df\u1a1e-\u1a1f\u1b5a-\u1b60\u1c3b-\u1c3f\u1c7e-\u1c7f\u2000-\u206e\u207d-\u207e\u208d-\u208e\u3008-\u3009\u2768-\u2775\u27c5-\u27c6\u27e6-\u27ef\u2983-\u2998\u29d8-\u29db\u29fc-\u29fd\u2cf9-\u2cfc\u2cfe-\u2cff\u2e00-\u2e7e\u3000-\u303f\u30a0\u30fb\ua60d-\ua60f\ua673\ua67e\ua874-\ua877\ua8ce-\ua8cf\ua92e-\ua92f\ua95f\uaa5c-\uaa5f\ufd3e-\ufd3f\ufe10-\ufe19\ufe30-\ufe52\ufe54-\ufe61\ufe63\ufe68\ufe6a-\ufe6b\uff01-\uff03\uff05-\uff0a\uff0c-\uff0f\uff1a-\uff1b\uff1f-\uff20\uff3b-\uff3d\uff3f\uff5b\uff5d\uff5f-\uff65]|\ud800[\udd00-\udd01\udf9f\udfd0]|\ud802[\udd1f\udd3f\ude50-\ude58]|\ud809[\udc00-\udc7e]/,
        m = /\s/, l = core.PositionFilter.FilterResult.FILTER_ACCEPT, r = core.PositionFilter.FilterResult.FILTER_REJECT, c = odf.WordBoundaryFilter.IncludeWhitespace.TRAILING, e = odf.WordBoundaryFilter.IncludeWhitespace.LEADING, p = {
            NO_NEIGHBOUR: 0,
            SPACE_CHAR: 1,
            PUNCTUATION_CHAR: 2,
            WORD_CHAR: 3,
    ...
    this.acceptPosition = function (b) {
        var f = b.container(), n = b.leftNode(), m = b.rightNode(), q = b.unfilteredDomOffset, s = function () {
...
gui.SelectionController = function (f, k) {
    ...
    function b(a, b, c) {
        ...
        var e = t.getRootElement(a) || t.getRootNode(), d = t.createRootFilter(e);
    ...
    function n(a, b, c) {
        ...
        e.init({memberid: k, position: a, length: b || 0, selectionType: c});
        return e
    }
    ...
    function l(a) {
        var b = v.getParagraphElements(a), c = b[0], b = b[b.length - 1];
        c && a.setStart(c, 0);
    ...
    function e(a, b) {
        var c, e = H, f = [new gui.LineBoundaryScanner, new gui.ParagraphBoundaryScanner];
        void 0 === e && z && (e = z());
        isNaN(e) || (c = d(), w.moveToFilteredStep(c, a, f) && c.advanceStep(a) && (f = [new gui.ClosestXOffsetScanner(e),
            new gui.LineBoundaryScanner, new gui.ParagraphBoundaryScanner], w.moveToFilteredStep(c, a, f) && (q(c.container(), c.offset(), b), H = e, C.restart())))
    }

    function p(a, b) {
        var c = d(), e = [new gui.LineBoundaryScanner, new gui.ParagraphBoundaryScanner];
        w.moveToFilteredStep(c, a, e) && q(c.container(), c.offset(), b)
    }

    function g(a, c) {
        var e = t.getCursor(k), e = h(e.getSelectedRange(), e.hasForwardSelection()), e = b(e.focusNode, e.focusOffset, D);
        e.advanceStep(a) && q(e.container(), e.offset(), c)
    }

    function x(a, b, c) {
        var e = !1, d = t.getCursor(k),
            d = h(d.getSelectedRange(), d.hasForwardSelection()), e = t.getRootElement(d.focusNode);
    ...
    var t = f.getOdtDocument(), y = core.DomUtils, v = odf.OdfUtils, s = t.getPositionFilter(),
        w = new gui.GuiStepUtils, u = t.createRootFilter(k), z = null, H, C, D = odf.WordBoundaryFilter.IncludeWhitespace.TRAILING, I = odf.WordBoundaryFilter.IncludeWhitespace.LEADING, N = core.StepDirection.PREVIOUS, K = core.StepDirection.NEXT;
    this.selectionToRange = function (a) {
        var b = 0 <= y.comparePoints(a.anchorNode, a.anchorOffset, a.focusNode, a.focusOffset), c = a.focusNode.ownerDocument.createRange();
    ...
    this.selectImage = function (a) {
        var b = t.getRootElement(a), c = t.createRootFilter(b), b = t.createStepIterator(a, 0, [c, t.getPositionFilter()], b), e;
        ...
        a = t.convertDomToCursorRange({
            anchorNode: c, anchorOffset: e, focusNode: b.container(),
    ...
    this.selectRange = function (a, b, c) {
        var e = t.getOdfCanvas().getElement(), d, g = [s];
        d = y.containsNode(e, a.startContainer);
        e = y.containsNode(e, a.endContainer);
        if (d || e)if (d && e && (2 === c ? m(a) : 3 <= c && l(a)), (c = b ? t.getRootElement(a.startContainer) : t.getRootElement(a.endContainer)) || (c = t.getRootNode()), g.push(t.createRootFilter(c)), r(c, g, a, !0), r(c, g, a, !1), a =
    ...
    this.extendSelectionToEntireDocument = function () {
        var a = t.getCursor(k), a = t.getRootElement(a.getNode()), b, c, e;
        ...
        e.roundToClosestStep();
        a = t.convertDomToCursorRange({anchorNode: b, anchorOffset: c, focusNode: e.container(), focusOffset: e.offset()});
        f.enqueue([n(a.position, a.length)]);
        return !0
    };
    this.destroy = function (b) {
...
gui.TextController = function (f, k, a, d, b, h) {
    ...
    function l(a) {
        var b, c, e, f = p.getParagraphElements(a), h = a.cloneRange(), l = [];
        b = f[0];
    ...
    var e = f.getOdtDocument(), p = odf.OdfUtils, g = core.DomUtils, x = !1, t = odf.Namespaces.textns, y = core.StepDirection.NEXT;
    this.isEnabled = function () {
        return x
    };
    this.enqueueParagraphSplittingOps = function () {
        if (!x)return !1;
        var a = e.getCursor(d), b = a.getSelectedRange(), c = r(e.getCursorSelection(d)), g = [], a = p.getParagraphElement(a.getNode()), k = a.getAttributeNS(t, "style-name") || "";
        0 < c.length && (g = g.concat(l(b)));
        b = new ops.OpSplitParagraph;
        b.init({
            memberid: d, position: c.position, paragraphStyleName: k, sourceParagraphPosition: e.convertDomPointToCursorStep(a,
                0, y), moveCursor: !0
        });
        g.push(b);
    ...
    this.insertText = function (a) {
        if (x) {
            var c = e.getCursor(d).getSelectedRange(), g = r(e.getCursorSelection(d)), h = [], k = !1;
            0 < g.length && (h = h.concat(l(c)), k = !0);
            c = new ops.OpInsertText;
            c.init({
                memberid: d,
                position: g.position, text: a, moveCursor: !0
            });
            h.push(c);
...
(function () {
    ...
    gui.SessionController = function (k, a, d, b) {
        ...
        function n(a, b) {
            var c = J.getDOMDocument(), e = null;
            c.caretRangeFromPoint ? (c = c.caretRangeFromPoint(a, b), e = {
                container: c.startContainer,
                offset: c.startOffset
            }) : c.caretPositionFromPoint && (c = c.caretPositionFromPoint(a, b)) && c.offsetNode && (e = {container: c.offsetNode, offset: c.offset});
            return e
        }
        ...
        function t(b) {
            var c = J.getCursor(a).getSelectedRange(), e = h(b).getAttribute("end");
        ...
        function v() {
            var a = T.getSelection(), b = 0 < a.rangeCount && W.selectionToRange(a);
        ...
        function w(a) {
            var b = J.getRootElement(a), c = J.createRootFilter(b), b = J.createStepIterator(a, 0, [c, J.getPositionFilter()], b);
            b.setPosition(a, a.childNodes.length);
        ...
        function u(a) {
            var b;
            b = (b = T.getSelection()) ? {anchorNode: b.anchorNode, anchorOffset: b.anchorOffset, focusNode: b.focusNode, focusOffset: b.focusOffset} : null;
            var c = T.getSelection().isCollapsed, e, d;
...
gui.CaretManager = function (f, k) {
    ...
    var h = {}, n = runtime.getWindow(), q = f.getSession().getOdtDocument(), m = f.getEventManager();
...
gui.EditInfoHandle = function (f) {
    var k = [], a, d = f.ownerDocument, b = d.documentElement.namespaceURI;
...
ops.EditInfo = function (f, k) {
    function a() {
        var a = [], d;
        for (d in b)b.hasOwnProperty(d) && a.push({memberid: d, time: b[d].time});
        a.sort(function (a, b) {
...
gui.HyperlinkTooltipView = function (f, k) {
    var a = core.DomUtils, d = odf.OdfUtils, b = runtime.getWindow(), h, n, q;
    ...
    this.showTooltip = function (m) {
        var l = m.target || m.srcElement, r = f.getSizer(), c = f.getZoomLevel(), e;
        a:{
            for (; l;) {
...
gui.OdfFieldView = function (f) {
    ...
    a = function () {
        var a = d.getElementsByTagName("head").item(0), f = d.createElement("style"), k = "";
        f.type = "text/css";
...
gui.ShadowCursor = function (f) {
    var k = f.getDOMDocument().createRange(), a = !0;
    this.removeFromDocument = function () {
    };
    this.getMemberId = function () {
...
gui.SelectionViewManager = function (f) {
    ...
    this.removeSelectionView = function (d) {
        a.hasOwnProperty(d) && (a[d].destroy(function () {
        }), delete a[d])
    };
...
(function () {
    gui.SessionView = function (f, k, a, d, b, h) {
        ...
        function e(c) {
            var e = c.getMemberId(), d = a.getOdtDocument().getMember(e).getProperties();
        ...
        function p(a) {
            a = a.getMemberId();
            var c = h.getSelectionView(k), e = h.getSelectionView(gui.ShadowCursor.ShadowCursorMemberId), d = b.getCaret(k);
        ...
        function x(b) {
            ...
            b = b.timeStamp;
            var d, f = "", g = c.getElementsByTagNameNS(w, "editinfo").item(0);
        ...
        var v, s, w = "urn:webodf:names:editinfo", u = {}, z, H, C, D = void 0 !== f.editInfoMarkersInitiallyVisible ? Boolean(f.editInfoMarkersInitiallyVisible) : !0, I = void 0 !== f.caretAvatarsInitiallyVisible ? Boolean(f.caretAvatarsInitiallyVisible) : !0, N = void 0 !== f.caretBlinksOnRangeSelect ? Boolean(f.caretBlinksOnRangeSelect) : !0;
...
gui.SvgSelectionView = function (f) {
    ...
    function d(b) {
        var c =
            w.getTextElements(b, !0, !1), e = b.cloneRange(), d = b.cloneRange();
        b = b.cloneRange();
        if (!c.length)return null;
        var f;
        a:{
            f = 0;
            var g = c[f], h = e.startContainer === g ? e.startOffset : 0, k = h;
            e.setStart(g, h);
            for (e.setEnd(g, k); !a(e);) {
                if (g.nodeType === Node.ELEMENT_NODE && k < g.childNodes.length)k = g.childNodes.length; else if (g.nodeType === Node.TEXT_NODE && k < g.length)k += 1; else if (c[f])g = c[f], f += 1, h = k = 0; else {
                    f = !1;
                    break a
                }
                e.setStart(g, h);
        ...
        a:{
            f = c.length - 1;
            g = c[f];
            k = h = d.endContainer === g ? d.endOffset :
                g.nodeType === Node.TEXT_NODE ? g.length : g.childNodes.length;
            d.setStart(g, h);
            for (d.setEnd(g, k); !a(d);) {
                if (g.nodeType === Node.ELEMENT_NODE && 0 < h)h = 0; else if (g.nodeType === Node.TEXT_NODE && 0 < h)h -= 1; else if (c[f])g = c[f], f -= 1, h = k = g.length || g.childNodes.length; else {
                    c = !1;
                    break a
                }
                d.setStart(g, h);
        ...
        return {firstRange: e, lastRange: d, fillerRange: b}
    }
    ...
    function n(a) {
        ...
        var d = a.commonAncestorContainer, f = a.startContainer, g = a.endContainer, k = a.startOffset, p = a.endOffset,
            l, n, m = null, q, r = x.createRange(), s, t = new odf.OdfNodeFilter, v;
        ...
        if (w.isParagraph(a))m = h(m, u.getBoundingClientRect(a)); else if (a.nodeType === Node.TEXT_NODE)d = a, r.setStart(d, k), r.setEnd(d, d === n ? p : d.length), q = r.getBoundingClientRect(), m = h(m, q); else for (v = x.createTreeWalker(a,
        ...
        l || (l = f);
        if (w.isParagraph(n))m = h(m, u.getBoundingClientRect(n)); else if (n.nodeType === Node.TEXT_NODE)d = n, r.setStart(d, d === a ? k : 0), r.setEnd(d, p), q = r.getBoundingClientRect(), m = h(m, q); else for (v = x.createTreeWalker(n, NodeFilter.SHOW_TEXT, b, !1), d = v.currentNode = g; d && d !== l;)if (r.setStart(d, 0), r.setEnd(d, p), q = r.getBoundingClientRect(), m = h(m, q), d = v.previousNode())p =
            d.length;
        return m
    }

    function q(a, b) {
        var c = a.getBoundingClientRect(), e = {width: 0};
        e.top = c.top;
        e.bottom = c.bottom;
        e.height = c.height;
    ...
    function m() {
        var a = f.getSelectedRange(), c;
        if (c = H && f.getSelectionType() === ops.OdtCursor.RangeSelection && !a.collapsed) {
            k();
            var e = u.getBoundingClientRect(g), h = z.getZoomLevel(), a = d(a), p, l, m, r, x, w;
            if (a) {
                c = a.firstRange;
                p = a.lastRange;
                l = a.fillerRange;
                ...
                h = x.top + x.height;
                w = [{x: m.left, y: e + m.height}, {x: m.left, y: e}, {x: r, y: e}, {x: r, y: h - x.height}, {x: x.right, y: h - x.height}, {x: x.right, y: h}, {
                    x: w,
                    y: h
                }, {x: w, y: e + m.height}, {x: m.left, y: e + m.height}];
                r = "";
                var C;
    ...
    var e = f.getDocument(), p, g, x = e.getDOMDocument(), t = x.createElementNS("http://www.w3.org/2000/svg", "svg"), y = x.createElementNS("http://www.w3.org/2000/svg",
        "polygon"), v = x.createElementNS("http://www.w3.org/2000/svg", "circle"), s = x.createElementNS("http://www.w3.org/2000/svg", "circle"), w = odf.OdfUtils, u = core.DomUtils, z = e.getCanvas().getZoomHelper(), H = !0, C = f.getDocument().createPositionIterator(e.getRootNode()), D = NodeFilter.FILTER_ACCEPT, I = NodeFilter.FILTER_REJECT, N;
...
gui.UndoStateRules = function () {
    function f(a, d) {
        ...
        this.previous = function () {
            for (f -= 1; 0 <= f; f -= 1)if (d(a[f]))return a[f];
            return null
        }
    }
...
(function () {
    ...
    gui.TrivialUndoManager = function (a) {
        ...
        function n() {
            C.emit(gui.UndoManager.signalUndoStackChanged, {undoAvailable: p.hasUndoStates(), redoAvailable: p.hasRedoStates()})
        }
        ...
        function e() {
            var a = b(), e = t = s.cloneDocumentElement();
        ...
        var p = this, g = "urn:webodf:names:cursor", x = core.DomUtils, t, y, v, s, w, u, z = [], H = [], C = new core.EventNotifier([gui.UndoManager.signalUndoStackChanged, gui.UndoManager.signalUndoStateCreated, gui.UndoManager.signalUndoStateModified, gui.UndoManager.signalDocumentModifiedChanged, gui.TrivialUndoManager.signalDocumentRootReplaced]), D = a || new gui.UndoStateRules, I = !1;
        this.subscribe = function (a, b) {
            C.subscribe(a, b)
        };
        this.unsubscribe = function (a, b) {
        ...
        this.onOperationExecuted = function (a) {
            if (!I) {
                var c = b();
                D.isEditOperation(a) && (u === y || 0 < H.length) || !D.isPartOfOperationSet(a, u.getOperations()) ? (H.length = 0, m(), u = new k(D, [a], !0), z.push(u), C.emit(gui.UndoManager.signalUndoStateCreated, {operations: u.getOperations()}), n()) : (u.addOperation(a), C.emit(gui.UndoManager.signalUndoStateModified, {operations: u.getOperations()}));
                q(c)
            }
        };
...
odf.GraphicProperties = function (f, k, a) {
    var d = this, b = odf.Namespaces.stylens, h = odf.Namespaces.svgns;
...
odf.PageLayoutProperties = function (f, k, a) {
    var d = this, b = odf.Namespaces.fons;
...
odf.StylePileEntry = function (f, k, a, d) {
    this.masterPage = function () {
        var b = f.getAttributeNS(odf.Namespaces.stylens, "master-page-name"), d = null;
        b && (d = a.getMasterPage(b));
        return d
    };
    (function (a) {
        var h = f.getAttributeNS(odf.Namespaces.stylens, "family"), n = null;
...
odf.StylePile = function (f, k) {
    ...
    var d = odf.Namespaces.stylens, b = {}, h = {}, n, q = {}, m = {}, l;
    l = function (d, c) {
        var e = q[d], f;
...
odf.StyleCache = function (f) {
    function k(a, b, c, e) {
        ...
        var d;
        if (b)for (b = b.split(" "), d = 0; d < b.length; d += 1)if (c = b[d])e.push(a), e.push(c)
    }
    ...
    function b(c, e) {
        var d = t.getStyleName("text", c), h = c.parentNode;
    ...
    var n = this, q, m, l, r, c, e, p, g = odf.Namespaces.textns, x = odf.Namespaces.stylens, t = new odf.StyleInfo, y = new odf.StyleParseUtils,
        v, s, w, u, z, H;
    ...
    this.update = function () {
        ...
        q = {text: c, paragraph: e, graphic: p};
...
ops.OperationTransformMatrix = function () {
    ...
    function h(a,
        ...
        if (b && b.attributes && (d || 0 < n.length)) {
            ...
            for (f = 0; f < m.length; f += 1)if (h = m[f], d && void 0 !== d[h] || n && -1 !== n.indexOf(h))m.splice(f, 1), f -= 1, l = !0;
    ...
    function m(a, b, d, f, k) {
        var l = a ? a[k] : null, m = b ? b[k] : null, r = d ? d[k] : null, s = f ? f[k] : null, w;
        w = h(l, m, r, s);
        l && !n(l) && delete a[k];
        m && !q(m) && delete b[k];
        r && !n(r) && delete d[k];
    ...
    r = {
        ...
        AddStyle: {
            AddStyle: l, ApplyDirectStyling: l, InsertText: l, MergeParagraph: l, MoveCursor: l, RemoveCursor: l, RemoveMember: l,
            ...
            }, RemoveText: l, SetParagraphStyle: l, SplitParagraph: l, UpdateMember: l, UpdateMetadata: l, UpdateParagraphStyle: l
        },
        ApplyDirectStyling: {
            ApplyDirectStyling: function (a, e, d) {
                ...
                var d = a.position, f = a.position + a.length;
                d >= b.sourceStartPosition && (d -= 1);
                f >= b.sourceStartPosition && (f -= 1);
                a.position = d;
                a.length = f - d;
                return {opSpecsA: [a], opSpecsB: [b]}
            }, MoveCursor: l, RemoveCursor: l, RemoveMember: l, RemoveStyle: l, RemoveText: function (a, b) {
                var d = a.position + a.length, f = b.position + b.length, h = [a], k = [b];
                ...
                return {opSpecsA: h, opSpecsB: k}
            }, SetParagraphStyle: l, SplitParagraph: function (a, b) {
                b.position < a.position ? a.position += 1 : b.position < a.position + a.length && (a.length += 1);
                return {opSpecsA: [a], opSpecsB: [b]}
            }, UpdateMember: l, UpdateMetadata: l, UpdateParagraphStyle: l
        },
        InsertText: {
            ...
            RemoveMember: l, RemoveStyle: l, RemoveText: function (a, b) {
                var d;
        ...
        MergeParagraph: {
            MergeParagraph: function (a, b, d) {
                ...
                a.destinationStartPosition === b.destinationStartPosition ? (f = [], h = [], a.moveCursor && (k = {
                    optype: "MoveCursor", memberid: a.memberid, timestamp: a.timestamp, position: a.sourceStartPosition -
                    1
                ...
                var d = b.position, f = b.position + b.length, h = Math.min(d, f), d = Math.max(d, f);
                h >= a.sourceStartPosition && (h -= 1);
                d >= a.sourceStartPosition &&
                (d -= 1);
                0 <= b.length ? (b.position = h, b.length = d - h) : (b.position = d, b.length = h - d);
                return {opSpecsA: [a], opSpecsB: [b]}
            }, RemoveCursor: l, RemoveMember: l, RemoveStyle: l, RemoveText: function (a, b) {
        ...
        MoveCursor: {
            MoveCursor: l, RemoveCursor: function (a,
                                                   b) {
                return {opSpecsA: a.memberid === b.memberid ? [] : [a], opSpecsB: [b]}
            }, RemoveMember: l, RemoveStyle: l, RemoveText: function (a, b) {
                var d = k(a), g = a.position + a.length, h = b.position + b.length;
        ...
        RemoveCursor: {
            ...
            }, RemoveMember: l, RemoveStyle: l, RemoveText: l, SetParagraphStyle: l, SplitParagraph: l, UpdateMember: l, UpdateMetadata: l, UpdateParagraphStyle: l
        },
        RemoveMember: {RemoveStyle: l, RemoveText: l, SetParagraphStyle: l, SplitParagraph: l, UpdateMetadata: l, UpdateParagraphStyle: l},
        RemoveStyle: {
            RemoveStyle: function (a,
                                   b) {
                var d = a.styleName === b.styleName && a.styleFamily === b.styleFamily;
                return {opSpecsA: d ? [] : [a], opSpecsB: d ? [] : [b]}
            }, RemoveText: l, SetParagraphStyle: function (a, b) {
                var d, f = [a], h = [b];
                ...
                return {opSpecsA: f, opSpecsB: h}
            }, SplitParagraph: l, UpdateMember: l, UpdateMetadata: l, UpdateParagraphStyle: function (b, e) {
                var f, g = [b], h = [e];
                "paragraph" ===
        ...
        RemoveText: {
            RemoveText: function (a, b) {
                ...
                var d = a.position + a.length, f = [a], h = [b];
        ...
        UpdateMember: {UpdateMetadata: l, UpdateParagraphStyle: l},
        UpdateMetadata: {
    ...
    this.extendTransformations =
        function (a) {
            Object.keys(a).forEach(function (b) {
                var d = a[b], f, h = r.hasOwnProperty(b);
    ...
    this.transformOpspecVsOpspec = function (a, b) {
        var d = a.optype <= b.optype, f;
        runtime.log("Crosstransforming:");
        runtime.log(runtime.toJson(a));
        runtime.log(runtime.toJson(b));
        d || (f = a, a = b, b = f);
        (f = (f = r[a.optype]) && f[b.optype]) ? (f = f(a, b, !d), d || null === f || (f = {opSpecsA: f.opSpecsB, opSpecsB: f.opSpecsA})) : f = null;
        runtime.log("result:");
