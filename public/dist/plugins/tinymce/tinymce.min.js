    ...
    r(l, [], function () {
        ...
        return function (r, i) {
            ...
            function p(e) {
                ...
                P = !0, i.fire("ObjectResizeStart", {target: w, width: w.clientWidth, height: w.clientHeight}), i.getDoc().selection.empty(), l(t, r, S)
            }
        ...
        return function (a) {
            ...
            function u() {
                p({
                    ...
                    alignleft: [{selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: {textAlign: "left"}, defaultBlock: "div"}, {
                        selector: "img,table",
                        collapsed: !1,
                        styles: {"float": "left"}
                    }],
        ...
        return function (r) {
            function v(e, t, n, i) {
                ...
                if (a = e.toLowerCase(), o = H.exec[a])return o(a, t, n), r.fire("ExecCommand", {command: e, ui: t, value: n}), !0;
        ...
        return v = {
            $: t, majorVersion: "4", minorVersion: "1.9", releaseDate: "2015-03-10", editors: [], i18n: s, activeEditor: null, setup: function () {
        ...
        function a(e) {
            ...
            c = i(), s({
                ...
                onPostRender: o("redo"),
                cmd: "redo"
            }), e.addMenuItem("visualaid", {text: "Visual aids", selectable: !0, onPostRender: a, cmd: "mceToggleVisualAid"}), s({
                cut: ["Cut", "Cut", "Meta+X"],
