tinymce.PluginManager.add("responsivefilemanager", function (e) {
    ...
    function t() {
        var t = window.innerWidth - 40, i = window.innerHeight - 60;
    ...
    e.addButton("responsivefilemanager", {
        ...
        shortcut: "Ctrl+E",
        onclick: t
    }), e.addShortcut("Ctrl+E", "", t), e.addMenuItem("responsivefilemanager", {icon: "browse", text: "Insert file", shortcut: "Ctrl+E", onclick: t, context: "insert"})
});
