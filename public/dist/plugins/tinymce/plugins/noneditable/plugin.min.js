tinymce.PluginManager.add("noneditable", function (a) {
    ...
    function d() {
        ...
        function g(a) {
            var b, c, d;
            if (a)b = m.getRng(!0), b.setStartBefore(a), b.setEndBefore(a), c = e(a), c && c.nodeValue.charAt(0) == o && (c = c.deleteData(0, 1)), k.remove(a, !0), m.setRng(b); else for (; (a = k.get(n)) && a !== d;)c = e(a), c && c.nodeValue.charAt(0) == o && (c = c.deleteData(0, 1)), k.remove(a, !0), d = a
        }
        ...
        function j(e) {
            ...
            if (o && (112 > s || s > 124) && s != l.DELETE && s != l.BACKSPACE) {
                ...
                if (e.preventDefault(), u)if (a.dom.isBlock(o)) {
                ...
                if (p = d(q)) {
                    ...
                    if (s == l.RIGHT || s == l.DELETE)if (o = f(p, !0), o && "false" === b(o)) {
