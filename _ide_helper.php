<?php
	...
	namespace {
		...
		class Vesta extends \App\Facades\VestaFacades
		{
			 ...
			 * @static
			 */
			public static function sendQuery($cmd, $arg1 = NULL, $arg2 = NULL, $arg3 = NULL, $arg4 = NULL, $arg5 = NULL, $arg6 = NULL)
			{
				return \App\Services\Vesta::sendQuery($cmd, $arg1, $arg2, $arg3, $arg4, $arg5, $arg6);
			}
			 ...
			 * @static
			 */
			public static function addWebDomain($domain)
			{
				return \App\Services\Vesta::addWebDomain($domain);
			}
			 ...
			 * @static
			 */
			public static function addDNSDomain($domain, $v_ip)
			{
				return \App\Services\Vesta::addDNSDomain($domain, $v_ip);
			}
			 ...
			 * @static
			 */
			public static function addMailDomain($domain)
			{
				return \App\Services\Vesta::addMailDomain($domain);
			}
			 ...
			 * @static
			 */
			public static function addWebDNSOnWebAlias($domain, $alias)
			{
				return \App\Services\Vesta::addWebDNSOnWebAlias($domain, $alias);
			}
			 ...
			 * @static
			 */
			public static function addWebDomainProxy($domain, $alias, $v_proxy_ext)
			{
				return \App\Services\Vesta::addWebDomainProxy($domain, $alias, $v_proxy_ext);
			}
