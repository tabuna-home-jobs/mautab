...
use Mautab\Services\WalletOne\Helper\ResponseCustomerFields;
use Mautab\Services\WalletOne\Helper\ResponseDataLoader;
...
class PaymentVerify
{
    use ResponseDataLoader;
    use ResponseCustomerFields;
