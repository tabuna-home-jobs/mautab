                ...
                <div class="row">
                    <div class="col-md-12 tabs-wrapper">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="features.html#home" data-toggle="tab">Быстрый старт</a></li>
                            <li><a href="features.html#profile" data-toggle="tab">Надёжность</a></li>
                            <li><a href="features.html#messages" data-toggle="tab">Современность</a></li>
                            <li><a href="features.html#settings" data-toggle="tab">Поддержка</a></li>
                        </ul>
                    ...
                    <div class="col-md-4">
                        <div class="chart first">
                            ...
                            <div class="specs">
                                ...
                                <div class="spec">
                                    <span class="variable">24/7</span>
                                    поддержка
                                </div>
                            </div>
                            <a class="btn btn-blue" href="/auth/register">
                                <span>Попробывать</span>
                            </a>
                    </div>
                </div>
                    <div class="col-md-4">
