                ...
                <div class="row">
                    <div class="col-md-12 tabs-wrapper">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="features.html#home" data-toggle="tab">Upstart your
                                    development</a></li>
                            <li><a href="features.html#profile" data-toggle="tab">Get ready in half the time</a></li>
                            <li><a href="features.html#messages" data-toggle="tab">Collaborate with everyone</a></li>
                            <li><a href="features.html#settings" data-toggle="tab">Get more done faster</a></li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="home">
                                <div class="col-md-6 info">
                                    ...
                                    <p>
                                        Whether you want to fill this paragraph with some text like I'm doing right now,
                                        this place is perfect to describe some features or anything you want - React has
                                        a complete solution for you.
                                    </p>

                                    <p>
                                        You have complete control over the look & feel of your website, we offer the
                                        best quality so you take your site up and running in no time.
                                    </p>
                                </div>
                            ...
                            <div class="tab-pane fade" id="messages">
                                ...
                                <div class="col-md-6 image">
                                    <img src="images/tabs/pic2.png" class="img-responsive"
                                         style="position: relative;top: 15px;" alt="picture3"/>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row feature">
                    <div class="col-md-6 info">
                        ...
                        <p>
                            ...
                            is perfect to describe some features or anything you want - React has a complete solution
                            for you.
                        </p>
                    </div>
                    <div class="col-md-6 image">
                ...
                <div class="row feature backwards">
                    <div class="col-md-6 info">
                        ...
                        <p>
                            You have complete control over the look & feel of your website, we offer the best quality so
                            you take your site up and running in no time.
                        </p>
                    </div>
                    <div class="col-md-6 image">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 feature">
                        ...
                        <p>You can work with international customers right out of the box while you can keep staying in
                            your country.</p>
                </div>
                    <div class="col-md-4 feature">
                        ...
                        <p>With some customization you can make this product apply to your branding guidelines and amaze
                            your customers at the same time.</p>
                    </div>
                    <div class="col-md-4 feature">
                        <img src="images/circle-icons/one-color/globe.png" alt="globe"/>
                        <strong>Develop once, run everywhere</strong>

                        <p>We don't impose any design restrictions, you are free to customize it as you see fit and it's
                            easy to use.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 feature">
                        ...
                        <p>We're always happy to offer support if you happen to have any doubts about anything, if you
                            need
                    ...
                    <div class="col-md-4 feature">
                        ...
                        <p>We'll be adding some new stuff to make it even more awesome, if you have any idea please let
                            us know.</p>
                    </div>
                    <div class="col-md-4 feature">
                        ...
                        <p>This thing will work on any device, it has a very easy to understand documentation and is
                            made with SASS.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row charts">
                    ...
                    <div class="col-md-4">
                        <div class="chart featured">
                            <div class="popular">Рекомендуемый</div>
                            <div class="quantity">
                                <span class="fa fa-rub"></span>
