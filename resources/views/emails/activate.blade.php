            ...
            <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%"
				...
				Item -->
                                    <div class="mob_center_bl"
                                        ...
                                        <table class="mob_center" width="115" border="0" cellspacing="0" cellpadding="0"
                                               align="left" style="border-collapse: collapse;">
                                            <tr>
                                                                ...
                                                                <a href="#" target="_blank"
                                                                   style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                                    <font face="Arial, Helvetica, sans-seri; font-size: 13px;"
                                                                          size="3" color="#596167">
                                                                        <img src="http://mautab.com/images/logo.png"
                                                                             alt="MauTab" border="0"
                ...
                <tr>
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						Вы зарегистрировались на <a href="http://mautab.com">MauTab</a>
					</span></font>
                                    </div>
                                    <!-- padding -->
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						Для активации вашего аккаунта<br>перейдите по данной ссылки
					</span></font>
                                    </div>
                                    <!-- padding -->
                                    <div style="height: 40px; line-height: 40px; font-size: 10px;"></div>
                            ...
                            <tr>
                                <td align="center">
                                    <div style="line-height: 24px;">
                                        <a href="http://mautab.com/auth/action/{{$email}}/{{$activationCode}}"
                                           target="_blank"
                                           style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                            <font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3"
                                                  color="#596167">

                                                <img src="http://artloglab.com/metromail/images/trial.gif" width="193"
                                                     height="43" alt="Активировать аккаунт" border="0"
                                                     style="display: block;"/></font></a>
                                    </div>
                                    <!-- padding -->
                                    <div style="height: 60px; line-height: 60px; font-size: 10px;"></div>
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <div class="mob_100" style="float: left; display: inline-block; width: 33%;">
                                        <table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0"
                                               align="left" style="border-collapse: collapse;">
                                            <tr>
                                                        ...
                                                        <font face="Arial, Helvetica, sans-serif" size="3"
                                                            ...
                                                            <strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
                                                                <a href="#1" target="_blank"
                                                                   style="color: #4db3a4; text-decoration: none;">Хостинг</a>
                                                            </strong></font>
                                                    </div>
                                                    <!-- padding -->
								...
								<span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #98a7b9;">
									Професиональный хостинг сайтов высокого уровня
								</span></font>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td align="center" style="line-height: 14px; padding: 0 27px;">
                                                        ...
                                                        <font face="Arial, Helvetica, sans-serif" size="3"
                                                            ...
                                                            <strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
                                                                <a href="#2" target="_blank"
                                                                   style="color: #4db3a4; text-decoration: none;">Системы
                                                                    управления</a>
                                                            </strong></font>
                                                    </div>
                                                    <!-- padding -->
                                                    ...
                                                    <div style="line-height: 21px;">
                                                        <font face="Arial, Helvetica, sans-serif" size="3"
                                                              color="#98a7b9" style="font-size: 14px;">
								<span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #98a7b9;">
									Удобные и понятные системы управления для Вашего бизнеса
								</span></font>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td align="center" style="line-height: 14px; padding: 0 27px;">
                                                        ...
                                                        <font face="Arial, Helvetica, sans-serif" size="3"
                                                            ...
                                                            <strong style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #4db3a4;">
                                                                <a href="#3" target="_blank"
                                                                   style="color: #4db3a4; text-decoration: none;">SEO
                                                                    сервисы</a>
                                                            </strong></font>
                                                    </div>
                                                    <!-- padding -->
                                                    ...
                                                    <div style="line-height: 21px;">
                                                        <font face="Arial, Helvetica, sans-serif" size="3"
                                                              color="#98a7b9" style="font-size: 14px;">
								<span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #98a7b9;">
									Развивайте свой проект используя бесплатные сервисы поисковой оптимизации
								</span></font>
                                                    </div>
                                                </td>
                                            </tr>
                                                           ...
                                                           style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                            <font face="Arial, Helvetica, sans-serif" size="2"
                                                                ...
                                                                <img src="http://artloglab.com/metromail/images/ng.gif"
                                                                     width="103" alt="National Geographic" border="0"
                                                                     class="mob_width_50"
                                                                     style="display: block; width: 100%; height: auto;"/></font></a>
                                                    </div>
                                                </td>
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					2015 © MauTab. Все права защищены.
				</span></font>
                                </td>
                            </tr>
                        </table>
