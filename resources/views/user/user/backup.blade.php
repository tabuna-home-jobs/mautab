...
@section('content')
        ...
        @forelse($Backups as $key =>  $Bakup)
            ...
            <!-- Modal -->
            <div class="modal fade" id="Modal-{{str_replace('.','-',$key)}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="{{URL::route('hosting.backup.destroy')}}" method="post">
