                        ...
                        <div class="ftp-groupz">
                            <div class="add-ftp-edit">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <small>
                                            Префикс {{Sentry::getUser()->nickname }}_ будет автоматически добавлен к
                                            названию аккаунта
                                        </small>
                                    </div>
                                    <input type="hidden" class="v-ftp-user-is-new" name="v_ftp_user[{{$key+1}}][is_new]"
                                           value="0"/>
                                    <input type="hidden" class="v-ftp-user-is-new" name="v_ftp_user[{{$key+1}}][is_old]"
                                           value="1"/>
                                ...
                                <div class="form-group">
                                    <label>Path</label>
                                    <input type="text" name="v_ftp_user[{{$key+1}}][v_ftp_path]" class="form-control"
                ...
                @elseif(!empty($d_val['FTP_USER']) && !is_array($d_val['FTP_USER']))
                    <div class="ftp-groupz">
                        <div class="add-ftp-edit">
                            ...
                            <div class="form-group">
                                <label>Пароль / <a href="#" class="genPass">сгенерировать</a></label>
                                <input type="text" name="v_ftp_user[1][v_ftp_password]" id="ftppas" class="form-control"
                                       value="********"/>
                            </div>
                            <div class="form-group">
                                <label>Path</label>
